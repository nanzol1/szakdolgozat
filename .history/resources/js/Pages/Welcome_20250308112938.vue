...
<template>
    ...
    <div class="bg-gray-50 text-black/100 dark:bg-black dark:text-white/50 pb-10">
        ...
        >
            <v-container fluid class="pa-0 shadow-md relative h-[400px] md:h-[300px]">
                <v-parallax scale="100px" src='storage/images/home_bg.jpg' height="100%">
                    <v-container>
                        <v-row>
                            <v-col>
                                <div class="relative !z-20 flex flex-col items-center py-8 h-auto text-stone-950 w-full">
                                    <div class="flex flex-col max-w-7xl items-center">
                                        ...
                                        <div class="lg:mt-4 text-center mt-3">
                                        ...
                                        <div class="lg:mt-5 text-center mt-3">
                                            <div class="text-body-1">
