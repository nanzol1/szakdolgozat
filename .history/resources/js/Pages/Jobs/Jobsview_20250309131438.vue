                            ...
                            >
                                ...
                                <template #arrow="{ prev, next }">
                                  <div class="custom-arrow">
                                    <button type="button" class="custom-arrow--left !bg-[#A67C52] hover:!bg-[#3A2618]" @click="prev">
                                      <v-icon icon="mdi mdi-chevron-left" size="30px"></v-icon>
                                    </button>
                                    <button type="button" class="custom-arrow--right !bg-[#A67C52] hover:!bg-[#3A2618]" @click="next">
