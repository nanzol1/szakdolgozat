...
const headers = ref([
    ...
    {title:'Alkategória megnevezés',align:'start',sortable:true,key:'subcat'},
    {title:'Jelentkezés Státusza',align:'start',sortable:true,key:'status'},
    {title:'Aktív',align:'start',sortable:true,key:'active'},
]);

const items = computed(() => {
    return Object.values(props.myjobs || {}).map(job => ({
        id:job.job_id,
        name:job.job_name,
