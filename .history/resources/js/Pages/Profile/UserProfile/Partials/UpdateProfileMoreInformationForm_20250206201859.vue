...
onMounted(() => {
    tesztref.value = form.education_type;
});
...
function teszt(){
    console.log(form.education_type);
    if(form.education_type == 'Egyetem'){
        console.log("asd");
    }
}
    ...
    <section class="w-full">
        ...
        >
            <div>
                ...
                <select v-model="tesztref" name="education_type" id="education_type">
