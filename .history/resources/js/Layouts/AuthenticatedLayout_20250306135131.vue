                            ...
                            <div class="relative ms-3">
                                <v-menu open-on-click>
                                    <template v-slot:activator="{props}">
                                        <v-avatar :image="'/storage/uploads/profile_picture/'+$page.props.auth.user.id+'/'+$page.props.auth.user.profile_photo_path" v-if="isCompany === 0"></v-avatar>
                                        <v-avatar :image="'/storage/uploads/company_profile/'+$page.props.auth.user.id+'/'+$page.props.auth.user.profile_pict" v-else></v-avatar>
                                        <v-btn
                                          v-bind="props"
                                          variant="text"
                                        ...
                                        <v-list-item-title>
                                            ...
                                            <v-menu open-on-hover v-else>
                                                ...
                                                <v-list>
                                                    ...
                                                    <v-list-item>
                                                        <v-list-item-title>
                                                            <Link :href="route('profile.edit.interests')" class="hover:text-sky-500">Munkahirdetés</Link>
                                                        </v-list-item-title>
                                                    </v-list-item>
                                                    <v-list-item>
                                                        <v-list-item-title>
