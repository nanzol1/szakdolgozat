        ...
        >
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    ...
                    <v-btn variant="tonal" @click="filterShow = true">Szűrők</v-btn>
                    <v-expand-transition>
                        <div v-if="filterShow" class="w-full h-auto my-3 bg-red-500">
                            asdsad
                            asdsad
                            asdsadasdsadasdsadasdsadasdsad
                            
                        </div>
                    </v-expand-transition>
                    <div class="flex">
                        <div class="flex flex-col gap-6 sm:grid lg:gap-2">
