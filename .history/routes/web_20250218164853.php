...
Route::middleware(['admin'])->group(function () {
    ...
    Route::get('admin/companies',[AdminLoginController::class,'getCompanies'])->name('admin.companies.show');
    Route::get('admin/companies/results',[AdminLoginController::class,'getCompanies'])->name('admin.companies.search'); 
    Route::get('admin/company/{id}',[AdminLoginController::class,'showCompany'])->name('admin.company.show');
    Route::post('{id}/randomPassword',[AdminLoginController::class,'generateRandomPasswordCompany'])->name('admin.company.randompassword');
});
