                            ...
                            <v-col cols="12">
                                ...
                                <div class="flex sm:gap-10">
                                    <v-sheet :elevation="5" :height="200" :width="200" class="!hidden sm:!block">
                                        <v-img  :lazy-src="'/storage/uploads/company_profile/'+job.created_by+'/'+job.companies.profile_pict"
                                        :src="'/storage/uploads/company_profile/'+job.created_by+'/'+job.companies.profile_pict" cover></v-img>
                                    </v-sheet>
