...
const checkMainCategory = (category) => {
    ...
    // Ha az adott alkategória már ki van pipálva, akkor töröljük
    if (checkboxes.value.includes(subCategoryId)) {
        checkboxes.value.splice(checkboxes.value.indexOf(subCategoryId), 1);

        // Ha nincs több bejelölt alkategória, a fő kategóriát is töröljük
        ...
        // Először töröljük az adott fő kategória többi alkategóriáját
