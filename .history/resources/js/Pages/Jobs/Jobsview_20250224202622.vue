                                ...
                                <div class="flex sm:gap-10">
                                    ...
                                    <div class="flex flex-col flex-1 gap-3">
                                        ...
                                        <div :class="['flex flex-col w-fit']">
                                            <v-btn variant="tonal" @click="sendApplication" :disabled="isApplied" v-if="isJobActive" :class="['mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 mb-2']">
                                                {{ computeApplied }}
                                            </v-btn>
                                            <v-btn variant="tonal" @click="revokeApplication" :class="['mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105']">
                                                Mégsem
                                            </v-btn>
                                        </div>
                                    </div>
