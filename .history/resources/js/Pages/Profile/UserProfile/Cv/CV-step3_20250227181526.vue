        ...
        <v-container>
          <v-row>
            ...
            <v-col cols="12" md="6">
              ...
              ></v-text-field>
              <v-radio-group v-model="skill.skill_level" inline label="Képesítési szint">
                <v-radio
                  color="#00e2f4"
                  label="-"
                  :value="1"
        ...
        <v-row>
          <v-col cols="12">
            ...
            <v-col cols="12" md="6" class="flex gap-4 flex-sm-wrap">
              <v-btn @click="prevStep" type="button" class="hover:bg-red-500 hover:text-gray-50">Vissza</v-btn>
