...
const checkMainCategory = (category) => {
    ...
    if(!checkboxes.value.includes('m'+category.maincateg_id)){
        ...
        let index = checkboxes.value.indexOf('m'+category.maincateg_id);
        /*if(index !== -1){
            checkboxes.value.splice(index,1);
        }*/
    }
    if(checkboxes.value.includes(category.key_id)){
        let index = checkboxes.value.indexOf(category.key_id);
        if(index >= 0){
            checkboxes.value.splice(index,1);
        }
    }
