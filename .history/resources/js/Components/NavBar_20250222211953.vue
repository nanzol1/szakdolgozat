...
<template>
    ...
    >
        <Disclosure as="nav" v-if="canLogin" :class="['text-amber-700 flex flex-wrap w-full justify-center gap-5 bg-fuchsia-500 p-2 xl:text-lg lg:text-md md:text-xs sm:text-sm',{'rounded-xl': isFixed}]" v-slot="{ open }">
            <Link
