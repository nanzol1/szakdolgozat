...
const page = usePage();
const navigation = [
  { name: 'Kezdőlap', href: route('/'), current: page.url === route('/') ? true : false },
  { name: 'Állások', href: route('jobs.show'), current: false },
  { name: 'Önéletrajz Készítés', href: route('cv.show'), current: false },
  { name: 'Hirdetésfeladás', href: route('register',{type:'munkaltato'}), current: false },
  { name: 'Bejelentkezés', href: route('login'), current: false },
  { name: 'Regisztráció', href: route('register',{type:''}), current: false },
]
