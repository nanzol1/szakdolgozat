        ...
        <v-container class="!max-w-7xl mx-auto">
            <v-row>
                <v-col>
                    ...
                    <h3 class="font-semibold leading-tight text-gray-800 mt-1">Ezen az oldalon tudja megtekinteni és szerkeszteni profilját.</h3>
                    <div class="flex gap-3 md:gap-5 text-md mt-3">
                        ...
                        <Link :href="route('profile.edit.interests')" class="hover:text-sky-500 transition">Érdekeltségeim</Link>
                        <Link :href="route('profile.edit.educations')" class="hover:text-sky-500 transition">Képzettségek</Link>
