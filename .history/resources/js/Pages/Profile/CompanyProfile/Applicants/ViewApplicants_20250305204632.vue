                            ...
                            {{ apps }}
                                ...
                                <v-card class="mb-3 pa-3">
                                    ...
                                    <v-card-actions>
                                        ...
                                        <a :href="'/storage/uploads/cv/'+apps.user.cv_file" :download="apps.user.name+'.pdf'" class="hover:bg-sky-500 hover:text-gray-50" v-if="apps.user.cv_file">Önéletrajz Letöltése</a>
                                    </v-card-actions>
                                </v-card>
                            </div>
