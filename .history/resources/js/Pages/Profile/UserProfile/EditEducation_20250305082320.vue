    ...
    <div class="max-w-7xl mx-auto">
        <v-container>
            <v-row>
                ...
                <v-overlay v-model="overlay" scroll-strategy="reposition" class="align-center justify-center" width="50%">
                    <v-card class="education-card !border-2 !border-solid !border-stone-950 w-[100%] xl:w-[60%] lg:w-[100%] xl:w-[60%] mx-auto" elevation="20">
