...
class DashboardController extends Controller{
    ...
    public function getAdvertisedJobsTable(Request $request)
    {
        ...
        if ($request->has('sortBy')) {
            ...
            switch ($request->sortBy) {
                case 'name':
                    $advertised->orderBy('job_name', $sortDirection);
                    break;
        
                case 'subcat':
                    $advertised->orderBy('subcategory_name', $sortDirection);
                    break;
        
                case 'status':
                    $advertised->orderBy('status_name', $sortDirection);
                    break;
        
                case 'active':
                    $advertised->orderBy('job_active', $sortDirection);
                    break;
        
                default:
                    $advertised->orderBy('applications.created_at', $sortDirection);
            }
        }
