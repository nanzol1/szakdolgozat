    ...
    <form @submit.prevent="handleSubmit">
      <template v-for="(educ, index) in educations" :key="index">
        <div>
          ...
          <TextInput id="school_name" type="text" v-model="educ.title" autocomplete="name"></TextInput>

          <InputLabel for="school_address" value="Munkáltató"></InputLabel>
          <TextInput id="school_address" type="text" v-model="educ.employer" autocomplete="school_address"></TextInput>

          <InputLabel for="location" value="Elhelyezkedés"></InputLabel>
          <TextInput id="location" type="text" v-model="educ.location" autocomplete="location"></TextInput>
