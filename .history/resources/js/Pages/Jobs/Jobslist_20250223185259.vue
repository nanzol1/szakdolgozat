                        ...
                        <v-expand-transition>
                            <div v-if="isFilterShow">
                                ...
                                <div v-for="cats in categories" :key="cats.mid"  class="mb-5">
                                    ...
                                    <div v-for="subcat in asd(cats.subcategories)" :key="subcat.id">
                                        <label :for="subcat.id">{{ subcat.name }}</label>
                                        <Checkbox v-model:checked="subcategory" :value="subcat.id" :id="subcat.id"></Checkbox>
                                    </div>
                                </div>
                                <v-range-slider
                                  v-model="payment"
