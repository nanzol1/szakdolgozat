            ...
            <section class="w-full">
                <div v-if="currentStepIndex === -1">
                    <form @submit.prevent="handleMainFormSubmit">
                        ...
                        <InputLabel for="firstname" value="Keresztnév"></InputLabel>
                        <TextInput id="firstname" type="text" v-model="formData.lastname" autocomplete="firstname"></TextInput>
                        <button type="submit" class="dark:text-white block">Next</button>
                    </form>
                </div>
