                ...
                <v-col>
                    <div class="flex">
                        <section class="w-1/2">
                            ...
                            <component v-else :is="steps[currentStepIndex].component" :key="currentStepIndex.valueOf" :formData="formData" @updateForm="updateForm" @nextStep="nextStep" :prevStep="prevStep" @submitForm="submitForm"></component>
                            </transition>
