                    ...
                    <v-col cols="12" lg="6">
                        <section class="bg-white p-4 shadow sm:rounded-lg sm:p-8 sm:py-2 dark:bg-gray-800 flex justify-between">
                            ...
                            <div>
                                ...
                                <v-text-field type="text" v-model="searchQuery" label="Foglalkoztatottság"></v-text-field>
                                <div class="flex flex-wrap align-center flex-row gap-2 bg-gray-300 pa-3" v-if="searchQuery.length > 3">
