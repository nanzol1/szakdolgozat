...
const fetchJobs = async () => {
    ...
    try{
        const response = await axios.post('/munka', params, {preserveState: true,preserveScroll: true,only: ["jobs"],});
        props.jobs.data = response.data.data;
    }catch(error){
        console.error(error);
    }
};
