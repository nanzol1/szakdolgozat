                                ...
                                <Link :href="route('jobs.view',{id:job.id})">
                                    ...
                                    >
                                        <template v-slot:prepend >
                                            <v-avatar v-if="job.company_avatar" :image="'storage/uploads/company_profile/'+job.company_id+'/'+job.company_avatar"></v-avatar>
                                      ...
                                      <v-card-subtitle>
                                        <span class="font-weight-black opacity-100">{{ job.name }}</span>
                                      </v-card-subtitle>
