...
const skills = ref([
  { title: '', employer: '', location: '', startdate: null, enddate: null,enddate_current: false, description: '' }
]);
...
const addSkill = () => {
  ...
  skills.value.push({ title: '', employer: '', location: '', startdate: null, enddate: null,enddate_current:false, description: '' });
    ...
    <form @submit.prevent="handleSubmit">
      <template v-for="(skill, index) in skills" :key="index">
        <div>
          ...
          <input type="date" v-model="skill.enddate" id="enddate" :disabled="isChecked-{index}">
          <input type="checkbox" v-model="skill.enddate_current" @change="isCurrentChecked">
