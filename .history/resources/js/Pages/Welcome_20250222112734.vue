...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        >
            <div class="relative flex flex-col items-center py-8 h-auto bg-stone-50 dark:bg-gray-600 dark:text-gray-50 text-stone-950 w-full">
                <div class="flex flex-col max-w-7xl items-center">
                    ...
                    <div class="lg:mt-4">
                        <v-btn variant="elevated" @click="router.visit(route('register',{type:'munkaltato'}))" class="!bg-red-500 hover:!bg-red-400">
                            Munkahirdetés
                        </v-btn>
                    </div>
                    <div class="lg:mt-5">
