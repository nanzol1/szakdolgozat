...
class JobsController extends Controller{
    ...
    public function getMyJobs(){
        $applications = Application::with('user','job_vacancy','job_status','job_vacancy.companies','job_vacancy.jobs_category',
                                        'job_vacancy.jobs_subcategory')->where('user_id',auth()->user()->id)->get()->toArray();
