...
Route::middleware('auth:company')->group(function () {
    ...
    Route::get('/search-schedules',[CompanyProfileController::class,'getWorkSchedules'])->name('profile.schedules.search'); 
    Route::get('company_profile/munkaim/edit/save',[CompanyProfileController::class,'getWorkSchedules'])->name('profile.schedules.search'); 
