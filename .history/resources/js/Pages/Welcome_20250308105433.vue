...
const computedSlidesPerView = computed(() => {
    if(availWidth.value <= 576){
        return 1;
    }else if(availWidth.value > 577 && availWidth.value <= 768){
        return 2;
    }else if(availWidth.value > 768 && availWidth.value <= 1200){
        return 2;
    }else{
        return 3;
    }
...
<template>
    ...
    <div class="bg-gray-50 text-black/100 dark:bg-black dark:text-white/50 pb-10">
        ...
        >
            <v-container fluid class="pa-0 gradient-bg">
                <v-container>
                    <v-row>
                        <v-col>
                            <div class="relative flex flex-col items-center py-8 h-auto  dark:text-gray-50 text-stone-950 w-full">
                                <div class="flex flex-col max-w-7xl items-center">
                                    ...
                                    <div class="lg:mt-4 text-center">
                                        ...
                                        <v-btn variant="elevated" @click="router.visit(route('register',{type:'munkaltato'}))" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 text-button mt-2">
                                            Munkahirdetés
                                        </v-btn>
                                    </div>
                                    <div class="lg:mt-5 text-center">
                                        ...
                                        <v-btn variant="elevated" @click="router.visit(route('jobs.show'))" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 text-button mt-2">
                                            Munkák böngészése
                                        </v-btn>
                                    </div>
                                </div>
...
.gradient-bg{
    background: linear-gradient(to right, #007bff8f, #00c6ff);
}
</style>
