...
<template>
    ...
    >
        <nav v-if="canLogin" :class="['flex flex-wrap w-full justify-center gap-5 bg-red-500 p-2 xl:text-lg lg:text-md md:text-xs sm:text-sm',{'rounded-xl': isFixed ? '2rem' : '0'}]">
            <Link
