                                ...
                                >
                                  ...
                                  >
                                    <Link :href="route('jobs.view',{id:featured.id})">
                                        <div class="relative flex flex-col h-full overflow-hidden bg-gray-50 max-md:w-[350px] max-sm:w-[100%] overflow-hidden">
                                            ...
                                            <div class="mb-3 ml-2 break-all">{{ featured.description }}</div>
