                                ...
                                >
                                  ...
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="d-flex flex-col fill-height align-center justify-center overflow-hidden">
                                        ...
                                        <div>{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}</div>
                                    </div>
                                </Link>
                                  </v-card>
                                </v-slide-group-item>
