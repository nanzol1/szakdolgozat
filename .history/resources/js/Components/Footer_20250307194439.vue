...
const acceptCookies = async() => {
  ...
  console.log(response.data.cookie_consent);
  Cookies.set('cookie_consent',response.data.cookie_consent,{expires:365,path:'/',sameSite:'Lax'});
};
    ...
    <div class="!fixed w-1/3 right-10 bottom-10">
        <transition-group tag="div" name="alert">
            <div v-if="showBanner" class="cookie-banner">
                <p>Használunk sütiket... <router-link to="/cookie-policy">Részletek</router-link></p>
