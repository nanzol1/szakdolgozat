    ...
    <v-form @submit.prevent="handleSubmit">
        <v-container>
          ...
          <template v-for="(educ, index) in educations" :key="index">
            ...
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="educ.startdate" type="month" clearable size="large" placeholder="Kezdés ideje" update-value-on-close :actions="[null]"/>
            </v-col>
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="educ.enddate" type="month" clearable size="large" placeholder="Végzés ideje" update-value-on-close :actions="[null]"/>
            </v-col>
      ...
      <v-container>
        <v-row>
          <v-col cols="12">
              <v-btn type="button" @click="addEducation"  class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50">Hozzáadás</v-btn>
            </v-col>
