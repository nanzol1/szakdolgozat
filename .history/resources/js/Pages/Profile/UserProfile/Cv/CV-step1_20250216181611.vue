...
// Quill inicializálása egy adott indexhez
const initializeQuill = (index) => {
  ...
  if (editorElement) {
    ...
    // Beállítjuk a kezdeti értéket, ha van description
    if (skills.value[index].description) {
      quill.root.innerHTML = skills.value[index].description;
    }

    // Figyeljük a változásokat és frissítjük a description-t
...
const addSkill = () => {
  ...
  // Quill inicializálása az új skill-hez
  nextTick(() => {
