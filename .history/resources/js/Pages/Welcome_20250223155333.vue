                            ...
                            <v-col>
                                <div class="flex max-lg:flex-col-reverse">
                                    <div class="flex flex-col gap-6 sm:grid w-full lg:gap-2 sm:grid-cols-1">
                                        ...
                                        <v-pagination v-model="currentPage" active-color="blue" ellipsis=".." size="large" density="compact" :total-visible="5" :length="totalPages" @update:model-value="fetchJobs"></v-pagination>
                                    </div>
