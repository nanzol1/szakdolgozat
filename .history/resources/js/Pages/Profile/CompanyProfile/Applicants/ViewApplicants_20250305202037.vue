                ...
                <v-row>
                    <v-col>
                        ...
                        <div class="flex gap-3 md:gap-5 text-md mt-3">
                            <Link :href="route('cprofile.edit')" :class="['hover:text-sky-500 transition',{'text-sky-500':$page.url === '/profile'}]">Alap adataim</Link>
                            <Link :href="route('cprofile.edit.interests')" class="hover:text-sky-500 transition">Érdekeltségeim</Link>
                            <Link :href="route('cprofile.edit.educations')" class="hover:text-sky-500 transition">Képzettségek</Link>
                            <Link :href="route('cprofile.edit.cv')" :class="['hover:text-sky-500 transition',{'text-sky-500':$page.url.includes('/cv')}]">Önéletrajz</Link>
                        </div>
                        <v-divider></v-divider>
                    </v-col>
                </v-row>
