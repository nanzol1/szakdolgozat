                        ...
                        <div class="relative max-w-7xl" >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <v-card
                                    :class="['ma-4 !bg-gray-300']"
                                    height="200"
                                    width="350"
                                    @click="toggle(); selectedJob = featured;"
                                  >
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="d-flex flex-col fill-height align-center justify-center overflow-hidden">
                                        <div>{{ featured.companies.company_name }}</div>
                                        <div>{{ featured.name }}</div>
                                        <div>{{ featured.address }}</div>
                                        <div>{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}{{ featured.description }}</div>
                                    </div>
                                </Link>
                                  </v-card>
                                </v-slide-group-item>
