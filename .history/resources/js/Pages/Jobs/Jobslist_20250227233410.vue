                        ...
                        <div class="w-full xl:w-1/5 mr-5 pr-5">
                            <v-tooltip text="Szűrők megjelenítése/elrejtése" location="top">
                                <template v-slot:activator="{ props }">
                                    <v-btn v-bind="props" variant="tonal" @click="handleFilterShow" :class="['mr-lg-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 mb-5',{'!bg-sky-500':isFilterShow}]">
                                        Szűrők
                                    </v-btn>
                                </template>
                            </v-tooltip>
