...
const jobCarousel = ref({
    id:'1',
    code:'code',
    name:'Name',
    description:'',
    image:'storage/uploads/company_profile/4/'+props.job.companies.profile_pict,
    price:100,
    category:'asd',
    quantity:100,
        ...
        <v-container class="flex-col pa-0" fluid>
            ...
            <v-container>
                <div class="w-full md:max-w-7xl mx-auto">
                    ...
                    <v-row>
                        <v-col>
                            <Carousel :value="jobCarousel" :numVisible="3" :numScroll="3" :responsiveOptions="responsiveOptions">
                                <template #item="slotProps">
                                    <div class="border border-surface-200 dark:border-surface-700 rounded m-2  p-4">
                                        <div class="mb-4">
                                            <div class="relative mx-auto">
                                                <v-img :src="'https://primefaces.org/cdn/primevue/images/product/' + slotProps.data.image" :alt="slotProps.data.name" class="w-full rounded" />
                                            </div>
                                        </div>
