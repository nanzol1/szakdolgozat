                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 align-center justify-between">
                        <div class="flex">
                            <!-- Navigation Links -->
                            <div
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex align-center" v-if="$page.props.auth.user"
                            >
                                <Link
                            ...
                            <div class="relative ms-3">
                                <v-menu open-on-click>
                                    <template v-slot:activator="{props}">
                                        <v-avatar v-if="$page.props.auth.user && $page.props.auth.user.profile_photo_path" :image="'/storage/uploads/profile_picture/'+$page.props.auth.user.id+'/'+$page.props.auth.user.profile_photo_path"></v-avatar>
                                        <v-avatar v-if="$page.props.auth.company && $page.props.auth.company.profile_pict" :image="'/storage/uploads/company_profile/'+$page.props.auth.company !== null ? $page.props.auth.company.id : 0+'/'+$page.props.auth.company !== null ? $page.props.auth.company.profile_pict : 0"></v-avatar>
                                        <v-btn
                                          v-bind="props"
                                          variant="text"
                                    ...
                                    <v-list>
                                      ...
                                      <v-list-item>
                                        <v-list-item-title>
                                            <Link href="" @click="router.post(route('logout'))" class="hover:text-sky-500">Kijelentkezés</Link>
                                        </v-list-item-title>
                                      </v-list-item>
                                    </v-list>
                                </v-menu>
