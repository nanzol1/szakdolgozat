...
<template>
    ...
    >
        <Disclosure as="nav" v-if="canLogin" :class="['text-gray-950 flex flex-wrap w-full justify-center gap-5  bg-sky-500 p-2',{'rounded-xl': isFixed}]" v-slot="{ open }">
            <Link
                    ...
                    <div class="mx-auto w-full px-2 sm:px-6 lg:px-8">
                      <div class="relative flex xl:h-12 lg:h-12 h-8 items-center justify-between">
                        <div class="absolute inset-y-0 left-0 flex items-center lg:hidden">
                          <!-- Mobile menu button-->
                          <DisclosureButton class="xl:text-xl lg:text-md md:text-xs sm:text-sm relative inline-flex items-center justify-center rounded-md p-2 focus:ring-2 dark:hover:bg-stone-950 dark:hover:text-gray-50 hover:bg-gray-50 focus:ring-white focus:outline-hidden focus:ring-inset">
