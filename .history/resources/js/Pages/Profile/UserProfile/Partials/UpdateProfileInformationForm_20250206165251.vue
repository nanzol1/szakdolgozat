    ...
    <section class="w-full">
        ...
        >
            ...
            <div>
                ...
                <Checkbox v-model:checked="driverLicense" id="none" value="none"></Checkbox>
                <InputLabel for="a" value="A" />
                <Checkbox v-model:checked="driverLicense" id="a" value="a"></Checkbox>
                <InputLabel for="b" value="B" />
                <Checkbox v-model:checked="driverLicense" id="b" value="b"></Checkbox>
                <InputLabel for="c" value="C" />
                <Checkbox v-model:checked="driverLicense" id="c" value="c"></Checkbox>
                <InputLabel for="d" value="D" />
                <Checkbox v-model:checked="driverLicense" id="d" value="d"></Checkbox>
                <InputLabel for="be" value="B+E" />
                <Checkbox v-model:checked="driverLicense" id="be" value="be"></Checkbox>
                <InputLabel for="ce" value="C+E" />
                <Checkbox v-model:checked="driverLicense" id="ce" value="ce"></Checkbox>
                <InputLabel for="de" value="D+E" />
                <Checkbox v-model:checked="driverLicense" id="de" value="de"></Checkbox>
