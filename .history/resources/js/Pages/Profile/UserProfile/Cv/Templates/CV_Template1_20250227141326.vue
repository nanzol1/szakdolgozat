...
<template>
    <div class="elevation-4 flex flex-col flex-1" style="width: 100%; height: 100% !important;">
        <div class="h-screen w-full" style="word-wrap: break-word;  max-width: 800px; width: 100%; padding: 20px; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
            ...
            <div style="margin-bottom: 30px;" v-if="formData.educations.length > 0 && formData.educations.every(e => e.school_name.trim() !== '')">
                ...
                <div style="margin-top: 15px;" v-for="(eds,index) in formData.educations" :key="index">
                    ...
                    <div style=" margin: 5px 0; color: #555;" v-if="eds.description" v-html="cleanQuillHTML(eds.description)"></div>
                </div>
            </div>
