            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    ...
                    <div class="flex max-lg:flex-col-reverse">
                        ...
                        <v-pagination v-model="currentPage" :total-visible="5" :length="totalPages" @update:model-value="changePage(page + 1)"></v-pagination>
                    </div>
                    <v-slide-x-reverse-transition>
                        <div v-if="filterShow" class="w-full lg:w-1/2 max-lg:my-3 lg:ml-10 bg-red-500">
                            ...
                            <div v-for="subcat in filteredSubcategories" :key="subcat.subcat_id">
                                <v-container>
                                  <p>{{ subcategory }}</p>
                                  <v-checkbox
                                    v-model="subcategory"
                                    :label="subcat.subcat_keyid"
