...
class CVController extends Controller{
    ...
    public function generatePdf(Request $request)
    {
        ...
        $pdf = Pdf::loadHTML($html)
            ->setPaper('a4', 'portrait') // A4 álló módban
            ->setOptions([
        ...
        $canvas->set_paper(array(0, 0, 595.28, 841.89)); // Teljesen levágja a margókat
    
        return $pdf->stream($request->input('fileName') ?? 'document.pdf');
    }
}
