                    ...
                    <div class="w-full xl:w-1/2 xl:flex-1 max-xl:mt-5">
                            <div v-for="job in jobs" :key="job.id">
                                <Link :href="route('jobs.view',{id:job.id})">
                                    ...
                                    <v-card
                                      :class="['mb-3',{'hover:bg-sky-500':isHovering}]"
                                    ...
                                    >
                                      ...
                                      <v-card-text :class="['bg-surface-light pt-4 max-h-28 overflow-hidden text-ellipsis text-clip',{'hover:!bg-sky-500':isHovering}]" id="job-desc-1">
                                        {{ job.description }}
                                      </v-card-text>
