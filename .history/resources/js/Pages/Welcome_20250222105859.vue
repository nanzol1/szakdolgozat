...
<template>
    <Head title="Kezdőlap" />
    <div class="bg-gray-500 text-black/50 dark:bg-red-500 dark:text-white/50">
        ...
        >
            <div class="flex flex-col py-8 h-auto bg-black-500 dark:bg-white dark:text-black w-full">
