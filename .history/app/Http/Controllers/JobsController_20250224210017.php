...
class JobsController extends Controller{
    ...
    public function jobView($id){
        $jobVacancy = JobVacancy::with('jobs_category','jobs_subcategory','companies','work_schedules','employment_type')->where('id','=',$id)->first();
        ...
        $cleanedData = [
            ...
            'profile_pict' => $jobVacancy->companies->profile_pict,
