                ...
                <v-col>
                    <div class="flex gap-10">
                        ...
                        <section class="w-1/2 h-screen p-[2.5em] bg-stone-200">
                            <component ref="cvTemplate" :is="tempaltes[0].component" :imagePreview="imagePreview" :formData="formData" :isAddition="isAddition" style="background-color: white; height: 100%;"></component>
                        </section>
                    </div>
                </v-col>
            </v-row>
