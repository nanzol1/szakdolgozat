...
const carouselItems = [
  [
    { title: 'Card 1', subtitle: 'Subtitle 1', text: 'Text for card 1' },
    { title: 'Card 2', subtitle: 'Subtitle 2', text: 'Text for card 2' },
    { title: 'Card 3', subtitle: 'Subtitle 3', text: 'Text for card 3' },
  ],
  [
    { title: 'Card 4', subtitle: 'Subtitle 4', text: 'Text for card 4' },
    { title: 'Card 5', subtitle: 'Subtitle 5', text: 'Text for card 5' },
    { title: 'Card 6', subtitle: 'Subtitle 6', text: 'Text for card 6' },
  ],
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid">
                        Ajánlott munkák
                        <div>
  <v-carousel show-arrows="hover" interval="5000">
    <v-carousel-item v-for="(item, index) in carouselItems" :key="index">
      <v-row>
        <v-col cols="12" xl="6" md="4" v-for="(card, cardIndex) in item" :key="cardIndex">
          <v-card
            :title="card.title"
