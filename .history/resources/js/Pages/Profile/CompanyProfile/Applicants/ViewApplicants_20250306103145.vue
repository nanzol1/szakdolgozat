                            ...
                            <v-overlay v-model="isPopup" class="align-center justify-center" width="100%">
                                <v-card class="education-card pa-4 !border-2 !border-solid !border-stone-950 w-[90%] xl:w-[50%] lg:w-[90%] mx-auto">
                                    ...
                                    <div v-if="selectedApplicant.cv_file">
                                        <v-btn :href="'/storage/uploads/cv/'+selectedApplicant.cv_file" :download="selectedApplicant.name+'.pdf'" class="hover:bg-sky-500 hover:text-gray-50" v-if="selectedApplicant.cv_file">Önéletrajz letöltése</v-btn>
                                    </div>
                                    {{ selectedApplicant }}
