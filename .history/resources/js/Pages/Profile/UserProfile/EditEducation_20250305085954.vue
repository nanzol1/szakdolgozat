...
const handleSelection = (id) => {
    ...
    overlay.value = true;
    form.education_name.value = selectedEducation.education_name;
    console.log(form.education_name);
};
                            ...
                            <div v-else>
                                <v-form @submit.prevent="submit">
                                    ...
                                    <div>
                                        ...
                                        type="text" :error="!!form.errors.education_name" :error-messages="form.errors.education_name"
                                        ></v-text-field>
                                        {{ new Date(selectedEducation.date_from).toLocaleDateString('HU') }} - {{ new Date(selectedEducation.date_to).toLocaleDateString('HU') }}
                                    </div>
                                    <div>
