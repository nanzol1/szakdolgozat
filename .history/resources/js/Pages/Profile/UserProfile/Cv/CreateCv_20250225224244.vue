...
const handleMainFormSubmit = () => {
  nextStep();
  const asd = steps[currentStepIndex.value].key;
  const asd2 = refs[asd];
  console.log(steps[currentStepIndex.value].component);
};
                ...
                <v-col>
                    <div class="flex">
                        <section class="w-1/2">
                            ...
                            <component v-else :is="steps[currentStepIndex].component" :key="steps[currentStepIndex].key" :formData="formData" @updateForm="updateForm" @nextStep="nextStep" @submitForm="submitForm"></component>
                            </transition>
                            <div>
                                <button
                                    @click="prevStep"
