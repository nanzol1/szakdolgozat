            ...
            <v-row>
                ...
                <v-col cols="6">
                    <v-card v-if="selectedJob">
                        ...
                        <v-card-subtitle>
                            <span class="font-weight-black !opacity-100 text-stone-950">{{selectedJob.job_catname}} / {{ selectedJob.job_scatname }}</span>
                            <v-divider class="border-opacity-100"></v-divider>
                        </v-card-subtitle>
                        <v-card-text>
                            <span class="font-weight-black">{{selectedJob.job_catname}} / {{ selectedJob.job_scatname }}</span>
                        </v-card-text>
                    </v-card>
                </v-col>
            </v-row>
