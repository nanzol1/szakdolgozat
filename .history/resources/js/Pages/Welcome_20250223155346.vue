                        ...
                        <div class="relative w-full overflow-hidden text-wrap md:mb-12 w-full" >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <v-card
                                    :class="['ma-4 !bg-gray-300 lg:w-[333px] w-full md:w-[460px] hover:scale-105 !transition']"
                                    height="200"
                            ...
                            <v-col>
                                <div class="flex max-lg:flex-col-reverse">
                                    <div class="flex flex-col gap-6 sm:grid w-full lg:gap-2 sm:grid-cols-1">
                                        ...
                                        <v-pagination v-model="currentPage" active-color="blue" ellipsis=".." size="md:large" density="compact" :total-visible="5" :length="totalPages" @update:model-value="fetchJobs"></v-pagination>
                                    </div>
