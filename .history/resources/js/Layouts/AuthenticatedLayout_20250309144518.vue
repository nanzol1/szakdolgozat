                            ...
                            <div class="relative ms-3">
                                <v-menu open-on-click>
                                    ...
                                    <v-list>
                                      <v-list-item>
                                        <v-list-item-title>
                                            <v-menu open-on-hover v-if="isCompany === 0" submenu>
                                                <template v-slot:activator="{props}">
                                                    <Link :href="route('profile.edit')" v-bind="props" class="hover:text-[#a67c52]">Profilom
                                            ...
                                            <v-menu open-on-hover v-else>
                                                <template v-slot:activator="{props}">
                                                    <Link :href="route('cprofile.edit')" v-bind="props" class="hover:text-[#a67c52]">Profilom
