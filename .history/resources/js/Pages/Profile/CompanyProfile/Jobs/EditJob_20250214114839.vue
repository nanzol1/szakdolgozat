...
const schedules = ref([]);
const activeCheckbox = ref(props.job.active);
...
onMounted(() => {
    activeCheckbox.value = props.job.active;
});
</script>
    ...
    <AuthenticatedLayout>
        ...
        >
            ...
            <div>
                ...
                {{ activeCheckbox }}
                <Checkbox v-model:checked="activeCheckbox" :value="activeCheckbox.value"></Checkbox>
