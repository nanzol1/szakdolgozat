...
<template>
    ...
    <div class="!fixed w-full right-0 bottom-0 pa-6 bg-gray-300">
        <transition-group tag="div" name="alert">
            <div v-if="showBanner" class="cookie-banner">
                <p>Az oldalon sütiket használunk a felhasználói élmény javítása érdekében!</p>
                <div class="flex"><v-btn @click="router.visit('/cookie-policy')" class="text-stone-950 bg-gray-50 pa-3">Részletek</v-btn></div>
                <div class="flex flex-col">
                    <v-btn class="hover:bg-green-500 hover:text-gray-50" @click="acceptCookies">Elfogadom</v-btn>
                    <v-btn class="hover:bg-red-500 hover:text-gray-50" @click="declineCookies">Elutasítom</v-btn>
                </div>
            </div>
        </transition-group>
    </div>
