    ...
    <v-form @submit.prevent="handleSubmit">
        <v-container>
          ...
          <template v-for="(exp, index) in exps" :key="index">
            ...
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="exp.startdate" type="month" clearable size="large" placeholder="Kezdés ideje" :actions="[null]"/>
            </v-col>
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="exp.enddate" type="month" clearable size="large" placeholder="Végzés ideje"  :actions="[null]"/>
            </v-col>
