...
Route::get('/munka/{id}',[JobsController::class,'jobView'])->name('jobs.view.edit');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/umunka/{id}/apply',[JobsController::class,'applyForJob'])->name('jobs.apply');
    Route::post('/umunka/{id}/apply-revoke',[JobsController::class,'revokeApplication'])->name('jobs.apply.revoke');
