...
<template>
    <div :class="['navbar max-w-7xl mx-auto',{'fixed-nav':isFixed}]" :style="{transform: isFixed ? 'translateY(0)' : 'translateY(10px)'}">
        <header
        :class="['grid items-center gap-2 static top-0 xl:w-full xl:px-[1em] lg:px-[10px]']"
