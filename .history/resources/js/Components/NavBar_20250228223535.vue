...
const navigation = [
  ...
  { name: 'Regisztráció', href: route('register',{type:''}), current: page.url === '/register' || page.url === '/register/munkavallalo' ? true : false , isVisible: page.props.auth.user === null ? '' : 'hidden'},
