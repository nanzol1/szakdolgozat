...
const nextStep = () => {
  if (currentStepIndex.value < steps.length - 1) {
    ...
    const currentStepRef = steps[currentStepIndex.value].key;
    console.log(currentStepRef);
    if(currentStepRef && currentStepRef.handleSubmit){
                ...
                <v-col>
                    <div class="flex">
                        <section class="w-1/2">
                            ...
                            :css="false"
                            >
                            <div v-if="currentStepIndex === 0" key="initial">
                            ...
                            <component v-else :is="steps[currentStepIndex].component" :key="steps[currentStepIndex].key" :ref="steps[currentStepIndex].key" :formData="formData" @updateForm="updateForm" @nextStep="nextStep" @submitForm="submitForm"></component>
                            </transition>
                            <div>
                                <button
                                    @click="prevStep"
                                ...
                                <button type="submit" class="dark:text-white" :disabled="currentStepIndex === steps.length - 1" @click="handleMainFormSubmit">Next</button>
                            </div>
                        </section>
                        <section class="w-1/2">
