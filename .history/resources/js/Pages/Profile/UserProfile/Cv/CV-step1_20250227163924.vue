...
<template>
  <div>
    <v-form @submit.prevent="handleSubmit">
      <template v-for="(exp, index) in exps" :key="index">
        <v-container>
          <v-row>
            ...
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="exp.startdate" type="month" clearable />
            </v-col>
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="exp.enddate" type="month" clearable />
            </v-col>
      ...
      <v-btn type="button" @click="addExperience"  class="hover:bg-sky-500 hover:text-gray-50">Add more</v-btn>
      <v-btn
          @click="prevStep"
      ...
      <v-btn type="submit" class="hover:bg-sky-500 hover:text-gray-50">Next</v-btn>
    </v-form>
  </div>
</template>