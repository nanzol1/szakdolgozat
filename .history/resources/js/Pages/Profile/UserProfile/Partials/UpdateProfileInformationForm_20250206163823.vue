...
<template>
    <section class="w-full">
        ...
        >
            ...
            <div>
                <InputLabel for="driverlicense" value="Nem rendelkezem jogosítvánnyal" />
                <Checkbox v-model:checked="driverlicenses" id="none"></Checkbox>
                <InputLabel for="driverlicense" value="a" />
                <Checkbox v-model:checked="driverlicenses" id="a"></Checkbox>
                <InputLabel for="driverlicense" value="b" />
                <Checkbox v-model:checked="driverlicenses" id="b"></Checkbox>
                <InputLabel for="driverlicense" value="c" />
                <Checkbox v-model:checked="driverlicenses" id="c"></Checkbox>
                <InputLabel for="driverlicense" value="d" />
                <Checkbox v-model:checked="driverlicenses" id="d"></Checkbox>
                <InputLabel for="driverlicense" value="B+E" />
                <Checkbox v-model:checked="driverlicenses" id="be"></Checkbox>
                <InputLabel for="driverlicense" value="C+E" />
                <Checkbox v-model:checked="driverlicenses" id="ce"></Checkbox>
                <InputLabel for="driverlicense" value="D+E" />
                <Checkbox v-model:checked="driverlicenses" id="de"></Checkbox>
