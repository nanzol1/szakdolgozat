...
watch(() => [formData.zip,formData.county,formData.city], async (data) => {
    if(data[0].length > 3 || data[1].length > 3 || data[2].length > 3){
        await debounceSearch(data);
        console.log(data);
    }
});
...
const debounceSearch = _.debounce(async(element) => {
    ...
    if(element[0].length > 3 || element[1].length > 3 || element[2].length > 3){
        try{
                                                ...
                                                <v-row v-if="isAddition">
                                                  ...
                                                  >
                                                    <v-combobox
                                                        ...
                                                        v-model:search="formData.county"
                                                    ></v-combobox>
                                                  </v-col>
                                                  <v-col
                                                    cols="12"
