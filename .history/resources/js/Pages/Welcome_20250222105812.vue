...
<template>
    <Head title="Kezdőlap" />
    <div class="bg-gray-50 text-black/50 bg-blue-500 dark:bg-red-500 dark:text-white/50">
        ...
        >
            <div class="flex flex-col py-8 h-auto bg-black dark:bg-white dark:text-black w-full">
