...
<template>
    ...
    >
        <Disclosure as="nav" v-if="canLogin" :class="['text-black dark:hover:!text-black flex flex-wrap w-full justify-center gap-5 bg-red-500 p-2 xl:text-lg lg:text-md md:text-xs sm:text-sm',{'rounded-xl': isFixed}]" v-slot="{ open }">
            <Link
