...
import { createLocale, enUS, NDatePicker,NConfigProvider  } from 'naive-ui';
import { hu } from 'date-fns/locale'

const customHuLocale = {
  ...enUS, // vagy ...huHU, ha a Naive UI tartalmaz magyar alapot
  name: 'hu',
  DatePicker: {
    ...enUS.DatePicker, // alapértelmezett angol DatePicker beállítások
    now: "Mai dátum",
    weekdays: ["Vasárnap", "Hétfő", "Kedd", "Szerda", "Csütörtök", "Péntek", "Szombat"],
    weekdaysShort: ['V', 'H', 'K', 'Sz', 'Cs', 'P', 'Szo'],
    firstDayOfWeek: 1 // hétfővel kezdődő hét
  }
}
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" lg="6">
                                        <div class="h-[56px] flex align-center">
                                            <NConfigProvider 
      :locale="{
        // Fontos: másold be az összes alapértelmezett tulajdonságot
        ...enUS,
        DatePicker: {
          ...enUS.DatePicker, // 🚨 Kötelező: örököld az összes alap DatePicker beállítást
          now:'Mai dátum',
          weekdaysShort: ['V', 'H', 'K', 'Sz', 'Cs', 'P', 'Szo'],
          firstDayOfWeek: 1
        }
      }"
      :date-locale="hu" <!-- 2. A 'hu' változónak importálva kell lennie -->
    >
      <n-date-picker 
