                        ...
                        <v-row>
                            <v-col cols="12">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" lg="6">
                                        <div>
                                            <v-text-field label="Telefonszám" type="text" v-model="form.phone_number" :error="!!form.errors.phone_number" :error-messages="form.errors.phone_number"></v-text-field>
                                        </div>
                                    </v-col>
                                    <v-col cols="12" lg="6">
                                        <div>
                                            <v-text-field label="Irányítószám" type="text" v-model="form.zip" :error="!!form.errors.zip" :error-messages="form.errors.zip"></v-text-field>
                                        </div>
                                    </v-col>
                                    <v-col cols="12" lg="6">
                                        <div>
                                            <v-text-field label="Megye" type="text" v-model="form.county" :error="!!form.errors.county" :error-messages="form.errors.county"></v-text-field>
                                        </div>
                                    </v-col>
                                    <v-col cols="12" lg="6">
                                        <div>
                                            <v-text-field label="Város" type="text" v-model="form.city" :error="!!form.errors.city" :error-messages="form.errors.city"></v-text-field>
                                        </div>
                                    </v-col>
                                    <v-col cols="12">
                                        <div>
                                    ...
                                    <v-col cols="12">
                                        <div>
                                            ...
                                            :error-messages="form.errors.cv_file" accept="image/png, image/jpeg, image/bmp" :rules="rule.fileRules" @change="renderImage" v-on:click:clear="renderImage"></v-file-input>
                                        </div>
                                        <v-expand-transition>
