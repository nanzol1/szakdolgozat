                    ...
                    >
                        ...
                        <div class="px-4" v-else>
                            <div
                                class="mb-2"
                            >
                            <v-avatar v-if="isCompany === 1 && $page.props.auth.user.profile_photo_path" :image="'/storage/uploads/profile_picture/'+$page.props.auth.user.id+'/'+$page.props.auth.user.profile_photo_path"></v-avatar>
                            </div>
                            <div
