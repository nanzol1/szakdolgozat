                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        <div v-for="(cats, catKey) in props.categories" :key="catKey">
                                            ...
                                            @click="isCatShown = cats.id" :class="['!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50 mb-2',{'!bg-sky-500 !text-gray-50':isCatShown == cats.id}]">{{ cats.name }}</v-btn>
