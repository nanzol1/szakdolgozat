...
const navigation = [
  ...
  { name: 'Hirdetésfeladás', href: is_company.value === 1 ? route('cprofile.edit.jobs') : route('register',{type:'munkaltato'}), current: page.url === '/hirdetes/feladas' ? true : false },
...
<template>
    ...
    >
        <Disclosure as="nav" :class="['text-gray-50 shadow-red-500 flex flex-wrap w-full justify-center gap-5 !border-solid !border-b !border-black bg-[#C7A07A] p-2 xl:text-xl lg:text-md md:text-xs sm:text-sm',{'rounded-xl': isFixed}]" v-slot="{ open }">
