...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        >
            <div class="flex flex-col h-auto bg-white w-full">
                ...
                <div class="mx-auto">
                    <Link as="button" :href="route('register',{type:'munkaltato'})">Munkahirdetés</Link>
                </div>
                <v-btn variant="tonal" :href="route('register',{type:'munkaltato'})">
                    Button
                </v-btn>
            </div>
