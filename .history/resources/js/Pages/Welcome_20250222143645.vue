                                  ...
                                  >
                                    <Link :href="route('jobs.view',{id:featured.id})">
                                        <div class="flex flex-col h-full overflow-hidden">
                                            ...
                                            <div class="absolute bottom-2 left-2"><div v-if="featured.companies.profile_pict = false" class="w-12 h-12 rounded-xl overflow-hidden absolute left-0 bottom-0 max-sm:hidden"><img class="w-[100%] h-[100%] object-cover" :src="'storage/uploads/company_profile/'+featured.companies.id+'/'+featured.companies.profile_pict" alt="Profile picture"></div><div :class="['relative left-16 max-sm:left-0',{'left-0':featured.companies.profile_pict}]">{{ featured.companies.company_name }}</div></div>
                                        </div>
                                    </Link>
                                  </v-card>
                                </v-slide-group-item>
