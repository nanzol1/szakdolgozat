...
const skills = ref([
  { title: '', employer: '', location: '', startdate: null, enddate: null,enddate_current: null, description: '' }
]);
...
const addSkill = () => {
  ...
  skills.value.push({ title: '', employer: '', location: '', startdate: null, enddate: null,enddate_current:null, description: '' });
