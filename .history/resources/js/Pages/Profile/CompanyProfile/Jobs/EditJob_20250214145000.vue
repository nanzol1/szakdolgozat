...
const checkMainCategory = (category) => {
    ...
    // Ha egy alkategóriát választunk
    if (checkboxes.value.includes(subCategoryId)) {
        // Távolítsuk el az összes többi alkategóriát
        checkboxes.value = checkboxes.value.filter(item => !item.startsWith('s'));

        // Adjuk hozzá a kiválasztott alkategóriát
        ...
        // Ha az alkategóriát eltávolítjuk, akkor távolítsuk el a főkategóriát is, ha nincs más alkategória
