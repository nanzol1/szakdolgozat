                        ...
                        <div v-for="seduc in selectedEducation" :key="seduc.id" class="flex flex-col pa-5">
                            ...
                            <div class="flex justify-between flex-wrap">
                                ...
                                <div class="flex gap-2 md:gap-4 flex-wrap">
                                    <v-btn v-if="isEditing" class="hover:bg-sky-500 hover:text-gray-50">Mentés</v-btn>
                                    <v-btn @click="isEditing = !isEditing" :type="isEditing === true ? 'submit' : 'button'" v-else class="hover:bg-sky-500 hover:text-gray-50">Szerkeszt</v-btn>
