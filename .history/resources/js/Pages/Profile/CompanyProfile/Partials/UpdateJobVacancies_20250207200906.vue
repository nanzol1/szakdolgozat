        ...
        >
            ...
            <div>
                ...
                <div v-for="cats in categories" :key="cats.id">
                    ...
                    <Checkbox :value="'m'+cats.id" v-model:checked="checkboxes" :id="cats.id" @change="toggleSubcategories(categories)">{{ categories.name }}</Checkbox>
                    <div v-for="subcats in cats.subcategories" :key="subcats.id">
                        <label :for="subcats.name">{{ subcats.name }}</label>
                        <Checkbox :value="'s'+subcats.id" v-model:checked="checkboxes" :id="subcats.name">{{ subcategories.name }}</Checkbox>
                    </div>
                </div>
