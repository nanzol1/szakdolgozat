...
class JobsController extends Controller{
    ...
    public function jobView($id){
        ...
        $cleanedData = [
            ...
            'company_name'=> $jobVacancy->companies->company_name ?? null,
            'requirements' => $jobVacancy->requirements,
            'payment' => $jobVacancy->payment,
            'maincateg_name' => $jobVacancy->jobs_category->name ?? null,
            'subcateg_name' => $jobVacancy->jobs_subcategory->name ?? null,
            'profile_pict' => $jobVacancy->companies->profile_pict ?? null,
            'created_by' => $jobVacancy->created_by,
            'maincateg_id' => $jobVacancy->maincateg_id ?? [],
            'subcateg_id' => $jobVacancy->subcateg_id ?? [],
            'work_schedules' => $jobVacancy->work_schedules->pluck('name'),
            'employment_type' => $jobVacancy->employment_type->pluck('name'),
        ];
