    ...
    <section class="w-full">
        ...
        >
            ...
            <div>
                ...
                />
                ss {{ institutions.institution_name }}
                <select v-if="searchQuery.length >= 1 && institutions" v-model="form.institution_name" name="institution_name" id="institution_name">
                ...
                <div v-if="searchQuery.length < 1 && !institutions">Nincs találat</div>
