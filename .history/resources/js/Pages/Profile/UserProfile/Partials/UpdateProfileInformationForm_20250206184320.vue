...
onMounted(() => {
    displayCV();
    driverLicenses.value = [...asdasd.faszomat_mar];
});
...
<template>
    <section class="w-full">
        ...
        >
            ...
            <div>
                <label for="none" value="Nem rendelkezem jogosítvánnyal"></label>
