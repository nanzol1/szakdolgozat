                    ...
                    <div class="w-1/5 mr-5 pr-5">
                        ...
                        <v-expand-transition>
                            <div v-if="isFilterShow">
                                ...
                                <div v-for="cats in categories" :key="cats.mid">
                                    <label :for="cats.mid">{{ cats.name }}</label>
                                    <Checkbox v-model:checked="category" :value="cats.mid" :id="cats.mid" class="mb-5"></Checkbox>
                                    <Checkbox v-model:checked="category" :value="cats.subcat_id" :id="cats.subcat_keyid"></Checkbox>
                                </div>
