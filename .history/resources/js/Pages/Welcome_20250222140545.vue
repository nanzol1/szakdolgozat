                                ...
                                >
                                  ...
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="flex flex-col h-full overflow-hidden">
                                        ...
                                        <div class="absolute bottom-2 left-2"><span><img :src="'storage/uploads/company_profile/'+featured.companies.id" alt=""></span><span>{{ featured.companies.company_name }}</span></div>
                                    </div>
                                </Link>
                                  </v-card>
                                </v-slide-group-item>
