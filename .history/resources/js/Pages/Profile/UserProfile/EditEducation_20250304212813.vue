    ...
    <div class="max-w-7xl mx-auto">
        <v-container>
            <v-row>
                ...
                <v-overlay v-model="overlay" scroll-strategy="reposition" class="align-center justify-center" width="100%" height="100%">
                    <v-card class="education-card !border-2 !border-solid !border-stone-950 w-[80%] xl:w-[30%] lg:w-[60%] mx-auto" elevation="20">
