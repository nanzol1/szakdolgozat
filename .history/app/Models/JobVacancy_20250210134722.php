...
class JobVacancy extends Model{
    ...
    protected $fillable = ['name','active','position','description','requirements','payment','created_by','maincateg_id','subcateg_id','employment_type'];
    ...
    public function work_schedules(){
        return $this->belongsTo(Work_schedule::class,'employment_type');
    }
}
