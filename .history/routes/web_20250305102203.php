...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile/kepzettsegek', [ProfileController::class, 'editCV'])->name('profile.edit.cv');
    Route::get('/profile/cv', [ProfileController::class, 'uploadCV'])->name('profile.edit.educations');
