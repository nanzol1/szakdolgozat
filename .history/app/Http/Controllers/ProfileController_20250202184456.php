...
class ProfileController extends Controller
{
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        $needChange['username'] = $user->username;
        $needChange['name'] = $user->name;
        $needChange['email'] = $user->email;

        $validated = Validator::make(array_merge($user->only(array_keys($needChange)),$needChange),[
