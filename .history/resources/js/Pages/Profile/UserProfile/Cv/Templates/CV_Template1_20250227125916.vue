...
function cleanQuillHTML(html) {
    ...
    tempDiv.querySelectorAll('ol').forEach(li => li.setAttribute('style','margin-left:1em;'));

    tempDiv.querySelectorAll('ul').forEach(li => li.setAttribute('style','margin-left:1em;'));

    tempDiv.querySelectorAll('ol li').forEach(li => li.setAttribute('style','padding-left:1em; list-style:numeric;'));
