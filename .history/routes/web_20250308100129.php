...
Route::get('advertised',[DashboardController::class,'getAdvertisedJobsTable'])
->middleware(['auth:company', 'verified'])->name('advertised.jobs.load');
...
Route::post('/sutik',[CookieConsentController::class,'store'])->name('cookie.consent');
...
Route::middleware('auth:company')->group(function () {
    ...
    Route::post('/company-profile/update', [CompanyProfileController::class, 'update'])->name('cprofile.update');
    ...
    Route::get('/cmunkaim',[JobsController::class,'getListedJobs'])->name('cprofile.myjobs');
    Route::get('/cmunka/{id}',[JobsController::class,'editListedJob'])->name('cprofile.myjobs.edit');
    ...
    Route::post('/cmunkaim/edit/save',[JobsController::class,'saveListedJob'])->name('cprofile.save.job'); 
    Route::get('/cmunka/{id}/jelentkezok',[JobsController::class,'showApplicants'])->name('cprofile.job.applicants');
    Route::get('/cmunka/{id}/jelentkezo/{jelentkezoId}',[JobsController::class,'showApplicant'])->name('cprofile.job.applicant');
    Route::put('/cmunka/{id}/jelentkezo/{jelentkezoId}/updateStatus/{statusId}',[JobsController::class,'updateStatus'])->name('cprofile.job.updatestatus');
});
