                    ...
                    >
                        <v-row>
                            <v-col cols="12">
                                ...
                                :error="!!form.errors.company_name" :error-messages="form.errors.company_name"></v-text-field>
                            </v-col>
                            <v-col cols="12">
                            ...
                            <div class="flex items-center gap-4">
                                <v-btn type="submit" :disabled="form.processing" class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-white">
