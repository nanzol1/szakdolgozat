                            ...
                            <div class="relative flex flex-col items-center py-8 h-auto text-stone-950 w-full">
                                <div class="flex flex-col max-w-7xl items-center">
                                    ...
                                    <div class="lg:mt-4 text-center">
                                        ...
                                        <v-btn variant="elevated" @click="router.visit(route('register',{type:'munkaltato'}))" class="!text-stone-50 !bg-[#A67C52] hover:!bg-sky-500 hover:scale-105 text-button mt-2">
                                            Munkahirdetés
                                        </v-btn>
                                    </div>
