...
const addSkills = () => {
  ...
  skills.value.push({ skill_name: '', skill_level: 0});
  ...
  <div>
    <form @submit.prevent="handleSubmit">
      <template v-for="(skill, index) in skills" :key="index">
        <div>
          <InputLabel for="skill_name" value="Iskola megnevezése"></InputLabel>
          <TextInput id="skill_name" type="text" v-model="skill.skill_name" autocomplete="name"></TextInput>

          <InputLabel for="school_address" value="Iskola címe"></InputLabel>
          <TextInput id="school_address" type="text" v-model="skill.school_address" autocomplete="address"></TextInput>
