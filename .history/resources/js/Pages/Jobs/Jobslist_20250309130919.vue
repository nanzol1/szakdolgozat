                        ...
                        <div class="w-full xl:w-1/5 mr-5 pr-5">
                            <v-tooltip text="Szűrők megjelenítése/elrejtése" location="top">
                                <template v-slot:activator="{ props }">
                                    <v-btn v-bind="props" variant="tonal" @click="handleFilterShow" :class="['mr-xl-3 !text-stone-50 !bg-[#A67C52] hover:!bg-[#3A2618] hover:scale-105 mb-5',{'!bg-sky-500':isFilterShow}]">
                                        Szűrők
                                    </v-btn>
                                </template>
                            </v-tooltip>
                            ...
                            <v-expand-transition>
                                <div v-if="isFilterShow">
                                    ...
                                    <v-btn variant="tonal" @click="handleCategories" :class="['mr-3 !text-stone-50 !bg-[#A67C52] hover:!bg-[#3A2618] hover:scale-105 mb-5',{'!bg-sky-500':isCategoriesShow}]">
                                        Kategóriák
                                    </v-btn>
                                    ...
                                    <v-btn variant="tonal" @click="handleWorkSchedules" :class="['mr-3 !text-stone-50 !bg-[#A67C52] hover:!bg-[#3A2618] hover:scale-105 mb-5',{'!bg-sky-500':isWorkSchedulesShown}]">
                                        Munkarend
                                    </v-btn>
                                    <transition-group tag="div" name="categories" mode="out-in">
                                    ...
                                    <v-btn variant="tonal" @click="handleEploymentType" :class="['mr-3 !text-stone-50 !bg-[#A67C52] hover:!bg-[#3A2618] hover:scale-105 mb-5',{'!bg-sky-500':isEmploymentTypeShown}]">
                                        Foglalkoztatottság
                                    </v-btn>
                                    <transition-group tag="div" name="categories" mode="out-in">
