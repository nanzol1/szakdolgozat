                        ...
                        <section>
                            ...
                            <v-overlay v-model="isPopup" class="align-center justify-center" width="100%">
                                <v-card class="education-card pa-4 !border-2 !border-solid !border-stone-950 w-[90%] xl:w-[50%] lg:w-[90%] mx-auto">
                                    ...
                                    <v-col cols="12">
                                        Név: {{ selectedApplicant.name }}
                                    </v-col>
                                    <v-col cols="12">
                                        Státusz: {{ selectedApplicant.status_name }}
                                    </v-col>
                                    <v-col cols="12">
                                        Születési dátum: {{ selectedApplicant.birth_date }} / ( {{ computeAge }} )
                                    </v-col>
                                    <v-col cols="12">
                                        E-mail cím: <a :href="'mailto:'+selectedApplicant.email">{{ selectedApplicant.email }}</a>
                                    </v-col>
                                    <v-col cols="12">
                                        Telefonszám: <a :href="'tel:'+selectedApplicant.phone">{{ selectedApplicant.phone }}</a>
                                    </v-col>
                                    <v-col cols="12">
                                        Bemutatkozás: {{ selectedApplicant.intro }}
                                    </v-col>
