                            ...
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <div v-for="(cats, catKey) in props.categories" :key="catKey">
                                        <v-btn variant="text" :append-icon="isCatShown ? 'mdi mdi-arrow-up' : 'mdi mdi-arrow-down'"
                                        @click="isCatShown = cats.id">{{ cats.name }}</v-btn>
                                        <div v-for="subcats in cats.subcategories" :key="subcats.id" v-if="isCatShown.includes(subcats.maincateg_id)">
