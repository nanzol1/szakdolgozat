    ...
    <section class="w-full">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div v-for="categories in category" :key="categories.id">
                ...
                <Checkbox :value="'m'+categories.id" v-model:checked="checkboxes" :id="categories.id">{{ categories.name }}</Checkbox>
                <div v-for="subcategories in categories.subcategories" :key="subcategories.id">
                    ...
                    <Checkbox :value="'s'+subcategories.id" v-model:checked="checkboxes" :id="subcategories.name" @change="toggleSubcategories(subcategories)">{{ subcategories.name }}</Checkbox>
                </div>
            </div>
            <div>
