                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        ...
                                        <template v-for="schedules in computeSchedules" :key="schedules.id">
                                            <div class="flex align-center gap-2 mb-2">
                                                <v-checkbox :label="schedules.name" v-model="form.work_schedules" :error="!!form.errors.work_schedules"
                                                :error-messages="form.errors.work_schedules" :value="schedules.id" class="h-fit"></v-checkbox>
                                            </div>
                                        </template>
                                    </v-col>
                                    <v-col cols="12">
