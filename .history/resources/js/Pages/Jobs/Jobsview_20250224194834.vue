                    ...
                    <v-row>
                        <v-col xl="12">
                            ...
                            <div class="text-lg font-weight-black">
                                <Link class="hover:text-sky-500" :href="'/munkak?category[0]='+job.maincateg_id">{{ job.maincateg_name }}</Link> / <Link :href="'/munkak?subcategory[0]='+job.subcateg_id">{{ job.subcateg_name }}</Link>
                            </div>
