                ...
                <main class="mt-6">
                    ...
                    <v-slide-x-reverse-transition>
                        <div v-if="filterShow" class="w-full lg:w-1/2 max-lg:my-3 lg:ml-10">
                            ...
                            <div class="mt-3">
                                <v-btn variant="tonal" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105" @click="startFilters" class="mr-3">Szűrés</v-btn>
                                <v-btn variant="tonal" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105" @click="setFiltersDefault">Alaphelyzetbe</v-btn>
                            </div>
                        </div>
                    </v-slide-x-reverse-transition>
                    </div>
