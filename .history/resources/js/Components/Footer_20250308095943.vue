    ...
    <div class="!fixed w-full right-0 bottom-0 pa-6 bg-gray-300">
        <transition-group tag="div" name="alert">
            <div v-if="showBanner" class="cookie-banner">
                <p>Az oldalon sütiket használunk a felhasználói élmény javítása érdekében! <Link :href="'/cookie-policy'" class="text-stone-950 hover:text-sky-500 text-md font-black">Részletek</Link></p>
