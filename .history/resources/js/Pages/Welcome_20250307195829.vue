...
const computePostDate = computed(() => {
    let posted = new Date(props.jobs.data.created_at);
    let today = new Date();
                                ...
                                <div class="lg:grid flex flex-col  grid-cols-1">
                                    ...
                                    <div class="relative w-full overflow-hidden text-wrap md:mb-12 w-full" >
                                        <n-carousel :slides-per-view="computedSlidesPerView" :space-between="20" :loop="false"
                                            ...
                                            >
                                                <Link v-for="job in jobs.data" :key="job.id" :href="route('jobs.view',{id:job.id})">
                                                    <n-card
                                                      :segmented="{
                                                        content: true,
                                                        footer: 'soft',
                                                    ...
                                                    >
                                                      ...
                                                      <template #action>
                                                        <div class="text-center">{{computePostDate}}</div>
                                                      </template>
                                                    </n-card>
                                                </Link>
