                        ...
                        <section>
                            ...
                            <v-overlay v-model="isPopup" class="align-center justify-center" width="100%">
                                <v-card class="education-card pa-4 !border-2 !border-solid !border-stone-950 w-[90%] xl:w-[50%] lg:w-[90%] mx-auto">
                                    ...
                                    {{ selectedApplicant }}
                                    <div class="flex w-full mt-3 justify-evenly">
                                        <v-btn class="hover:bg-sky-500 hover:text-gray-50" @click="updateStatus(props.job_id,selectedApplicant.value.user_id,4)">Elfogad</v-btn>
                                        <v-btn class="hover:bg-sky-500 hover:text-gray-50" @click="updateStatus(props.job_id,selectedApplicant.value.user_id,5);">Elutasít</v-btn>
