                                ...
                                >
                                  ...
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="flex flex-col h-full overflow-hidden">
                                        ...
                                        <div class="absolute bottom-2 left-2"><div class="w-12 h-12"><img :src="'storage/uploads/company_profile/'+featured.companies.id+'/'+featured.companies.profile_pict" alt=""></div><span>{{ featured.companies.company_name }}</span></div>
                                    </div>
                                </Link>
                                  </v-card>
                                </v-slide-group-item>
