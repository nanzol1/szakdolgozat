...
const navigation = [
  ...
  { name: 'Bejelentkezés', href: route('login'), current: page.url === '/login' ? true : false,isVisible: isLoggedIn === false ? 'hidden' : ''},
  { name: 'Regisztráció', href: route('register',{type:''}), current: page.url === '/register' ? true : false , isVisible: isLoggedIn === false ? 'hidden' : ''},
