...
class JobVacancy extends Model{
    ...
    protected $fillable = ['name','address','active','position','description',
    'requirements','payment','created_by','maincateg_id','subcateg_id',
    'employment_type','work_schedules','views'];
    ...
    public function employments_type(){
        return $this->belongsToMany(Employment_type::class,'advertised_jobs_employment_type','job_vacancy_id','employment_type_id');
    }
