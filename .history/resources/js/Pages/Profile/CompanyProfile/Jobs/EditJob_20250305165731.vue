                                ...
                                <v-col cols="12">
                                    <div v-for="(cats, catKey) in props.categories" :key="catKey">
                                        ...
                                        <div v-for="subcats in cats.subcategories" :key="subcats.id" v-if="isCatShown == cats.id" class="pl-10 mb-2">
                                            ...
                                            <Checkbox class="!border-1 !border-solid !border-black" :value="'s'+subcats.id" v-model:checked="checkboxes" :id="subcats.name" @change="checkMainCategory(subcats)">{{ subcats.name }}</Checkbox>
                                        </div>
                                    </div>
                                </v-col>
                            </v-row>
