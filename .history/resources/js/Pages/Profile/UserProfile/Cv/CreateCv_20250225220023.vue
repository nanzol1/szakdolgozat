    ...
    <GuestPageLayout :canLogin="canLogin" :canRegister="canRegister">
        <div class="flex align-center">
            <section class="w-full">
                ...
                <component  :is="steps[currentStepIndex].component" :key="steps[currentStepIndex].key" :formData="formData" @updateForm="updateForm" @nextStep="nextStep" @submitForm="submitForm"></component>
                </transition>
                <div>
                    <button
                        @click="prevStep"
