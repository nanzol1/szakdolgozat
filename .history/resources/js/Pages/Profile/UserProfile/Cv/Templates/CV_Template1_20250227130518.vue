...
function cleanQuillHTML(html) {
    ...
    tempDiv.querySelectorAll('[data-list]').forEach(li => console.log(li.getAttribute('data-list') === 'bullet' ? li.nextSibling.setAttribute('style','list-style:inside;') : li.nextSibling.setAttribute('style','list-style:numeric;')));
