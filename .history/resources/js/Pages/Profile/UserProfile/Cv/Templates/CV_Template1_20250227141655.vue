...
<template>
    <div class="elevation-4" style="width: 100%; height: 100%;">
        <div class="w-full" style="word-wrap: break-word;  max-width: 800px; width: 100%; padding: 20px; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
            ...
            <div style="margin-bottom: 30px;" v-if="formData.more_descs && formData.more_descs.length > 0 && formData.more_descs.every(e => e.more_desc.trim() !== '')">
