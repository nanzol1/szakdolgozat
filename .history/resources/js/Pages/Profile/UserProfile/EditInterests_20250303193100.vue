            ...
            <v-row>
                <v-col>
                    ...
                    <div class="flex gap-3 md:gap-5 text-md mt-3">
                        <Link href="#alapadatok" class="hover:text-sky-500 transition">Alap adataim</Link>
                        <Link :href="route('profile.edit.interests')" class="hover:text-sky-500 transition">Érdekeltségeim</Link>
                        <Link :href="route('profile.edit.editEducations')" class="hover:text-sky-500 transition">Képzettségek</Link>
                    </div>
                </v-col>
            </v-row>
        </v-container>
