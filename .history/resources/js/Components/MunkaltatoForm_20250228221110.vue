...
const rules = {
    ...
    passwordRules: [
        ...
        v => !/(password|123456|qwerty|asdfgh|jelszo|secret|admin|login|hello|love)/i.test(v) || 'Gyenge jelszó',
        v => !new RegExp(`${this.form.email?.split('@')[0]}|${this.form.username}|${this.form.name}`,'i').test(v) || 'Nem tartalmazhat személyes adatokat'
    ],
};
