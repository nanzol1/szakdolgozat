...
<template>
    <section>
        ...
        >
            <div>
                <InputLabel for="positions" value="positions" />
            ...
            <div>
                ...
                <textarea name="descriptions" id="descriptions" v-model="form.descriptions" placeholder="Munka leírása" class="w-full"></textarea>
            ...
            <div>
                ...
                <textarea name="requirements" id="requirements" v-model="form.requirements" placeholder="Elvárások" class="w-full"></textarea>
            ...
            <div>
                ...
                <textarea name="payments" id="payments" v-model="form.payments" placeholder="Fizetés" class="w-full"></textarea>
