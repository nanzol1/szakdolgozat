                            ...
                            <div class="relative flex flex-col items-center py-8 h-auto  dark:text-gray-50 text-stone-950 w-full">
                                <div class="flex flex-col max-w-7xl items-center">
                                    ...
                                    <div class="lg:mt-4 text-center">
                                        ...
                                        <v-btn variant="elevated" @click="router.visit(route('register',{type:'munkaltato'}))" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 text-button">
                                            Munkahirdetés
                                        </v-btn>
                                    </div>
                                    <div class="lg:mt-5 text-center">
                                        ...
                                        <v-btn variant="elevated" @click="router.visit(route('jobs.show'))" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 text-button">
                                            Munkák böngészése
                                        </v-btn>
                                    </div>
                                </div>
