                                ...
                                >
                                  ...
                                  >
                                    <Link :href="route('jobs.view',{id:featured.id})">
                                        <div class="flex flex-col h-full overflow-hidden bg-gray-500">
                                            <div class="featured-card-title bg-red-400 flex justify-between flex-wrap"><span>{{ featured.name }}</span><span>{{ featured.jobs_subcategory.name }}</span></div>
