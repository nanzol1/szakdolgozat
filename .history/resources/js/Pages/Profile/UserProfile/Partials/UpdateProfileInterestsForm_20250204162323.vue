    ...
    <section class="w-full">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div v-for="categories in category" :key="category.id">
                ...
                <Checkbox :value="categories.id" v-model:checked="checkboxes" :id="categories.name" @change="toggleSubcategories(categories)">{{ categories.name }}</Checkbox>
                <div v-for="subcategories in categories.subcategories">
                    <label :for="subcategories.name">{{ subcategories.name }}</label>
                    <Checkbox :value="subcategories.id" v-model:checked="checkboxes" :id="subcategories.name">{{ subcategories.name }}</Checkbox>
                </div>
            </div>
            <div>
