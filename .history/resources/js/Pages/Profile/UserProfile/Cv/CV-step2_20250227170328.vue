      ...
      <template v-for="(educ, index) in educations" :key="index">
        <v-container>
          <v-row>
            ...
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="educ.startdate" type="month" clearable size="large" placeholder="Kezdési idő"/>
            </v-col>
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="educ.enddate" type="month" clearable size="large"/>
            </v-col>
