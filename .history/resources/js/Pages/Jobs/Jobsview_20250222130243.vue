...
<template>
    ...
    <button @click="sendApplication" :disabled="isApplied" v-if="isJobActive && auth()->user"> {{ computeApplied }}</button>
    <button @click="revokeApplication" :disabled="!isApplied" v-if="isJobActive">Mégsem</button>
</template>