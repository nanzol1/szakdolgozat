            ...
            <v-col xl="12" class="break-words">
                <div class="flex w-full">
                    <div class="w-1/5 mr-5 pr-5">
                        <v-btn variant="tonal" @click="handleFilterShow" class="mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 mb-3">Szűrők</v-btn>
                        <v-expand-transition>
                            <div v-if="isFilterShow">
                                <v-text-field label="Keresés..." v-model="search"></v-text-field>
                                <Link as="button">Kategóriák</Link>
