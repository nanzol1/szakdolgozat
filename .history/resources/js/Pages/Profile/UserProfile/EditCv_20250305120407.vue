    ...
    if(user.cv_file){
        ...
        pdfjsLib.getDocument(url).promise.then(function(pdf) {
            pdf.getPage(1).then(function(page) {
                ...
                var targetWidth = Math.max(containerWidth, 800);
                var scale = targetWidth / defaultViewport.width;
