    ...
    <section class="w-full">
        ...
        <form @prevent.submit="form.post(route('profile.update.interests'))">
            ...
            <div v-for="categories in category">
                {{ categories.name }}
                <div v-for="subcategories in categories">
                    <div v-for="infos in subcategories">
                        {{ infos }}
                        <Checkbox :value="infos.name" v-model:checked="checkboxes" :id="infos.name">{{ infos.name }}</Checkbox>
                    </div>
                </div>
            </div>
