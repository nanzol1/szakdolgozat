...
/*const loadTemplate = async () => {
    ...
    const response = await axios.get('/cvmaker/previewCV',{
...
const generatePDF = async() => {
    const htmlContent = cvTemplate.value.$el;
    ...
    const fullHTML = `
        <html>
            ...
            <body class="font-sans antialiased" style="width: 100% !important; height: 100% !important; padding: 0 !important; margin: 0 !important;">
                ${htmlContent}
            </body>
        </html>
    `;
    ...
    await alink.addStyleTag({ path: 'styles.css' });
    alink.href = url;
