                            ...
                            <div v-for="job in jobs" :key="job.id">
                                <Link :href="route('jobs.view',{id:job.id})">
                                    ...
                                    >
                                      ...
                                      <v-card-text hover="hover:!bg-sky-500" class="bg-surface-light pt-4 max-h-28 overflow-hidden text-ellipsis text-clip" id="job-desc-1">
                                        {{ job.description }}
                                      </v-card-text>
