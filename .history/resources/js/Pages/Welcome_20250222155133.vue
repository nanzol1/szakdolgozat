                                ...
                                >
                                  ...
                                  >
                                    <Link :href="route('jobs.view',{id:featured.id})">
                                        <div class="relative flex flex-col h-full overflow-hidden bg-gray-50 max-md:w-[350px] max-sm:w-[100%]">
                                            ...
                                            <div class="mb-3 ml-2 truncate text-ellipsis  max-sm:w-[100vw] max-sm:px-1">{{ featured.description }}</div>
