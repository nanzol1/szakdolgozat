...
<template>
    ...
    >
        <Disclosure as="nav" v-if="canLogin" :class="['text-gray-950 flex flex-wrap w-full justify-center gap-5  bg-sky-500 p-2 xl:text-lg lg:text-md md:text-xs sm:text-sm',{'rounded-xl': isFixed}]" v-slot="{ open }">
            <Link
            ...
            <template v-else>
                    <div class="mx-auto w-full px-2 sm:px-6 lg:px-8">
                      <div class="relative flex xl:h-12 lg:h-12 h-8 items-center bg-transparent justify-between">
