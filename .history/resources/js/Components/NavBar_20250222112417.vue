                    ...
                    <div class="mx-auto w-full px-2 sm:px-6 lg:px-8">
                      <div class="relative flex xl:h-16 lg:h-12 h-8 items-center justify-between">
                        <div class="absolute inset-y-0 left-0 flex items-center lg:hidden">
                          <!-- Mobile menu button-->
                          <DisclosureButton class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-50 dark:hover:bg-stone-950 hover:bg-gray-50 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset">
