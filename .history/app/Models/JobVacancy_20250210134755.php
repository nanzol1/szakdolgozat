...
class JobVacancy extends Model{
    ...
    protected $fillable = ['name','active','position','description','requirements','payment','created_by','maincateg_id','subcateg_id','employment_type','work_schedules'];
    ...
    public function work_schedules(){
        return $this->belongsTo(Work_schedule::class,'work_schedules');
    }
}
