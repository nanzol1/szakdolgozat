            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    <div class="lg:grid">
                        ...
                        <div class="relative w-full overflow-hidden text-wrap md:mb-12" >
                            <v-sheet
                              elevation="8"
                              width="100%"
                            >
                              ...
                              >
                                ...
                                >
                                  <v-card
                                    :class="['ma-4 !bg-gray-300 lg:w-[335px] w-full']"
                                    height="200"
                    ...
                    <div class="grid gap-6 lg:gap-2">
                        ...
                        <div class="w-full" v-for="job in jobs.data" :key="job.id">
                            <Link :href="route('jobs.view',{id:0})">
                                <v-card
                            ...
                            <button v-if="jobs.prev_page_url" @click="fetchJobs(jobs.prev_page_url)">Előző</button>
    <button v-if="jobs.next_page_url" @click="fetchJobs(jobs.next_page_url)">Következő</button>
                        </div>
                    </div>
                </main>
            </div>
