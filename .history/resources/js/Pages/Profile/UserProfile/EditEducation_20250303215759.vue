...
<template>
    ...
    <div class="max-w-7xl mx-auto">
        <v-container>
            <v-row>
                <v-col cols="12">
                    <v-btn @click="newEducation = !newEducation" class="hover:bg-sky-500 hover:text-gray-50 mb-3 align-center">
                        Új végzettség felvétele
                        <v-icon icon="mdi mdi-plus-circle-outline" class="ml-1"></v-icon>
                    </v-btn>
                    <v-expand-transition>
                        <div
