                ...
                <v-col>
                    <div class="flex">
                        ...
                        <section class="w-1/2 flex flex-col flex-1" style="box-sizing: border-box; min-height: 297mm;">
                            ...
                            <component ref="cvTemplate" class="flex flex-col flex-1-1 fill-height" :is="tempaltes[0].component" :formData="formData" :isAddition="isAddition" style="width: 100%; height: 100%; min-height: 260mm;"></component>
                        </section>
                    </div>
                </v-col>
            </v-row>
