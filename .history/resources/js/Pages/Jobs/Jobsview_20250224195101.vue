                        ...
                        <v-col xl="12">
                            ...
                            <div class="flex sm:gap-10">
                                ...
                                <div class="flex flex-col flex-1">
                                    ...
                                    <div class="text-lg font-weight-black content-center align-center items-center content-center align-content-center">
                                        <v-icon icon="mdi-briefcase"></v-icon><div class="inline ">{{ job.company_name }}</div>
                                    </div>
                                </div>
                            </div>
                        </v-col>
