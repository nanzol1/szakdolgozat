...
<template>
    ...
    <div class="bg-gray-50 text-black/100 dark:bg-black dark:text-white/50">
        ...
        >
            ...
            <div class="relative w-fsull max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    <div class="lg:grid">
                        <div class="lg:text-xl mb-2 mt-4">
                            Ajánlott munkák
                        </div>
                        <div class="relative lg:max-w-7xl break-all" >
                            <v-sheet
                              elevation="8"
                              width="100%"
                            >
                                ...
                                >
                                  ...
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="d-flex flex-col fill-height align-center justify-center overflow-hidden">
                                        ...
                                        <div>{{ featured.jobs_subcategory.name }}</div>
                                        <div>{{ featured.description }}</div>
                                        <div class="absolute left-2 bottom-2">{{ featured.companies.company_name }}</div>
