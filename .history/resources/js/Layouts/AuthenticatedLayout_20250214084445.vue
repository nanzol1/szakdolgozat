                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" v-if="isCompany == 1">
                                <NavLink
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" v-if="isCompany == 0">
                                <NavLink
                                    :href="route('myjobs')"
                                    :active="route().current('myjobs')"
                                >
                                    Munkáim
                                </NavLink>
                            </div>
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center">
                            ...
                            <div class="relative ms-3">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink v-if="isCompany == 0"
                                            :href="route('profile.edit')"
                                        >
                                            Profile
                                        </DropdownLink>
                                        <DropdownLink v-if="isCompany == 1"
