...
function cleanQuillHTML(html) {
    ...
    tempDiv.querySelectorAll('[data-list]').forEach(li => console.log(li.getAttribute('data-list') === 'bullet' ? li.setAttribute('style','list-style:inside; list-style-type:dot;') : li.setAttribute('style','list-style:inside;list-style-type:dot;')));
