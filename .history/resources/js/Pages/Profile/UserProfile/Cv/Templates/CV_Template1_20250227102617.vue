...
<template>
    <div class="elevation-4 flex flex-col flex-1" style="width: 100%; height: 100%;">
      <div class="flex flex-col flex-1" style="background-color: red; width: 35%; height: 100%;">
          <v-card class="" style="background-color:red; width: 100%; height: 100%; display: flex; flex-direction: column;">
