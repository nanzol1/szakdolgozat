...
<template>
    <div class="elevation-4 flex flex-col flex-1" style="width: 100%; height: 100%;">
        <div class="h-screen w-full" style="word-wrap: break-word;  max-width: 800px; height: 100vh !important; width: 100%; padding: 20px; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
