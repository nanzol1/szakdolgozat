                        ...
                        <v-row>
                            <v-col cols="12">
                                <div class="text-lg font-weight-black mb-2">
                                    <Link class="hover:text-sky-500 transition" :href="'/munkak?category[0]='+job.maincateg_id">{{ job.jobs_category.maincateg_name }}</Link> / <Link class="hover:text-sky-500 transition" :href="'/munkak?subcategory[0]='+job.subcateg_id">{{ job.subcateg_name }}</Link>
                                </div>
                                <div class="flex sm:gap-10">
                                    <v-sheet :elevation="5" :height="200" :width="200" class="!hidden sm:!block">
                                        <v-img :src="'/storage/uploads/company_profile/'+job.created_by+'/'+job.companies.profile_pict" cover></v-img>
                                    </v-sheet>
