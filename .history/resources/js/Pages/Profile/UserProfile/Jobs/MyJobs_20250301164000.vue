...
const payment = computed(() => {
    if(props.myjobs.data.job_payment === null){
        return 'Nincs megadva havi bér';
    }else{
        let price = 0;
        price = props.myjobs.data.job_payment.toLocaleString('hu-HU',{
            style:'currency',
            currency:'Huf',
                        ...
                        <v-card-text>
                            <div class="flex flex-col mb-2">
                                ...
                                <div class="flex align-center gap-1">
                                    <span class="hidden sm:block"><v-icon icon="mdi mdi-cash"></v-icon></span><span>{{payment}}</span>
                                </div>
