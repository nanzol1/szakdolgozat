                ...
                <v-row>
                    <v-col>
                        ...
                        <div class="flex gap-3 md:gap-5 text-md mt-3 flex-col md:flex-row">
                            ...
                            <Link :href="route('cprofile.edit.jobs')" :class="['hover:text-[#fff] transition',{'text-gray-50':$page.url.includes('hirdetes')}]">Munkahirdetés</Link>
                            <Link :href="route('cprofile.myjobs')" class="hover:text-[#fff] transition">Munkáim</Link>
                        </div>
                    </v-col>
                </v-row>
            </v-container>
