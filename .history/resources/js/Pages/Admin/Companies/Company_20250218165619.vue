    ...
    <AdminLayout>
            <div class="dark:text-white">
                ...
                <template v-for="jobs in advertised_jobs" :key="jobs.id">
                    <div v-if="jobs">
                        {{ jobs }}
                        <button @click="isPopup = true">Megtekintem</button>
                    </div>
                </template>

                <Dialog v-model:visible="isPopup" modal header="Alaphelyzetbe állítás" :style="{ width: '25rem', background: 'white' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
