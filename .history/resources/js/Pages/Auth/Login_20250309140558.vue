                    ...
                    <v-row>
                        <v-col>
                            <div class="relative !z-20 flex flex-col items-center py-8 h-auto text-stone-950 w-full">
                                <div class="flex flex-col max-w-5xl items-center">
                                    <div class="mx-auto text-h4 flex w-full">
                                        Bejelentkezés / 
                                        <Transition name="slide-up">
                                            <div class="w-full">
                                                <span v-if="form.logintype === 'munkavallalo'" class="absolute ml-3">Munkavállaló</span>
                                                <span v-else class="absolute">Munkáltató</span>
                                            </div>
                                        </Transition>
                                    </div>
                                </div>
