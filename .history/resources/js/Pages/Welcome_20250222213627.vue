        ...
        >
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    ...
                    <div>
                        További munkákért, és részletesebb szűrési lehetőségért látogass el az Állások oldalra!
                    </div>
                    <div class="my-3">
                        <v-btn class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105" @click="handleFilterShow">Szűrők</v-btn>
                        <v-btn class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 ml-3" @click="router.visit(route('jobs.show'))">Több munka</v-btn>
                    </div>
