...
const navigation = [
  ...
  { name: 'Önéletrajz készítő', href: '#', current: false },
  { name: 'Hirdetésfeladás', href: '#', current: false },
  { name: 'Bejelentkezés', href: '#', current: false },
  { name: 'Regisztráció', href: '#', current: false },
]
const items = ref([
    {
        label:'Kezdőlap',
