        ...
        >
            <div class="relative flex flex-col items-center py-8 h-auto bg-gray-100 dark:bg-gray-600 dark:text-gray-50 text-stone-950 w-full">
                <div class="flex flex-col max-w-7xl items-center">
                    ...
                    <div class="lg:mt-4">
                        <v-btn variant="elevated" @click="router.visit(route('register',{type:'munkaltato'}))" class="!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-110">
                            Munkahirdetés
                        </v-btn>
                    </div>
                    <div class="lg:mt-5">
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    ...
                    <div class="my-3">
                        <v-btn class="!text-stone-50 !bg-gray-500 hover:!bg-gray-400" @click="handleFilterShow">Szűrők</v-btn>
                    </div>
                    ...
                    <v-slide-x-reverse-transition>
                        <div v-if="filterShow" class="w-full lg:w-1/2 max-lg:my-3 lg:ml-10">
                            ...
                            <div class="mt-3">
                                <v-btn variant="tonal" @click="startFilters" class="mr-3">Szűrés</v-btn>
                                <v-btn variant="tonal" @click="setFiltersDefault">Alaphelyzetbe</v-btn>
                            </div>
                        </div>
                    </v-slide-x-reverse-transition>
                    </div>
