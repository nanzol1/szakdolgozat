                            ...
                            <div class="relative ms-3">
                                <v-menu open-on-click>
                                    <template v-slot:activator="{props}">
                                        <v-avatar v-if="isCompany === 1" :image="'/storage/uploads/profile_picture/'+$page.props.auth.user.id+'/'+$page.props.auth.user.profile_photo_path"></v-avatar>
                                        <v-avatar v-else :image="'/storage/uploads/company_profile/'+$page.props.auth.company.id+'/'+$page.props.auth.company.profile_pict"></v-avatar>
                                        {{ '/storage/uploads/company_profile/'+$page.props.auth.company.id+'/'+$page.props.auth.company.profile_pict }}
                                        <v-btn
                                          v-bind="props"
                                          variant="text"
