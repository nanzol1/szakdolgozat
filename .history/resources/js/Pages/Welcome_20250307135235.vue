...
<template>
    ...
    <div class="bg-gray-50 text-black/100 dark:bg-black dark:text-white/50 pb-10">
        ...
        >
            <v-container fluid class="pa-0 bg-gray-100 dark:bg-gray-600">
                <v-container>
                    <v-row>
                        <v-col>
                            <div class="relative flex flex-col items-center py-8 h-auto  dark:text-gray-50 text-stone-950 w-full">
                                    ...
                                    <div class="relative w-full overflow-hidden text-wrap md:mb-12 w-full" >
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              <v-card
                                                :class="['ma-4 !bg-gray-300 xl:w-[310px] lg:w-[330px] md:w-[430px] sm:w-[420px] max-sm:w-[220px] w-full hover:scale-105 !transition']"
                                                height="200"
                                                @click="toggle(); selectedJob = featured;"
                                              >
                                                <Link :href="route('jobs.view',{id:featured.id})">
                                                    <div class="relative flex flex-col h-full overflow-hidden bg-gray-50">
                                                        <div class="featured-card-title flex-col bg-sky-400 flex justify-between flex-wrap"><span>{{ featured.name }}</span><span>{{ featured.jobs_subcategory.name }}</span></div>
                                ...
                                <div class="my-3">
                                    <v-tooltip text="Szűrők megjelenítése/elrejtése" location="top">
                                        <template v-slot:activator="{ props }">
                                            <v-btn v-bind="props" variant="tonal" @click="handleFilterShow" :class="['mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105',{'!bg-sky-500':isFilterShow}]">
                                                Szűrők
                                            </v-btn>
                                        </template>
                                    </v-tooltip>
                                    ...
                                    <v-slide-x-reverse-transition>
                                        <div v-if="filterShow" class="w-full lg:w-1/2 max-lg:my-3 lg:ml-10">
                                            ...
                                            <v-combobox
                                              ...
                                              :return-object="false"
                                            ></v-combobox>
                                            max: {{ props.max_spayment }}
                                            <br>
                                            min: {{ props.min_spayment }}
                                            <v-range-slider
                                              v-model="payment"
                                              :max="props.max_spayment?.payment ?? props.max_spayment"
                                              :min="props.min_spayment?.payment ?? props.min_spayment"
                                              step="1"
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <v-tooltip text="Szűrők alaphelyzetbe állítása">
                                                    <template v-slot:activator="{ props }">
                                                        <v-btn v-bind="props" variant="tonal" @click="setFiltersDefault" :class="['!text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105']">
                                                            Alaphelyzet
                                                        </v-btn>
                                                    </template>
                                                </v-tooltip>
