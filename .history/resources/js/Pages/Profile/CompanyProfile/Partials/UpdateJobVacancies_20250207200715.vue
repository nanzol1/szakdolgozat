    ...
    <section>
        ...
        >
            ...
            <div>
                ...
                <select name="position" id="position" v-model="form.position" v-for="cats in categories">
                    <select name="" id="" v-for="">
                        <option value="cats.name" v-for="cats in categories" :key="cats.id">{{ cats.name }}</option>
                    </select>
                </select>
