                ...
                <v-row>
                    <v-col cols="12">
                        <div class="w-fit mx-auto">
                            <div>
                            <v-switch :label="computeLabel" v-model="form.logintype" base-color="                            <v-label :v-slot="label">{{computeLabel}}</v-label>
" color="green" false-value="munkavallalo" true-value="munkaltato"></v-switch>
