    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if($request->logintype === 'munkavallalo'){
            ...
            if($user && Auth::guard('web')->attempt($credentials)) {
                ...
                Log::logAction('bejelentkezes','Bejelentkezést hajtott végre',auth('web')->user()->id);
            ...
            if($company && Auth::guard('company')->attempt($credentials)) {
                ...
                Log::logAction('bejelentkezes','Bejelentkezést hajtott végre',auth('company')->user()->id);
