                ...
                <v-col>
                    <div class="flex">
                        <section class="w-1/2">
                            ...
                            <component v-else :is="steps[currentStepIndex].component" :key="steps[currentStepIndex].key" :formData="formData" @updateForm="updateForm" @nextStep="nextStep" :prevStep="prevStep" @submitForm="submitForm"></component>
                            </transition>
                            <div>
