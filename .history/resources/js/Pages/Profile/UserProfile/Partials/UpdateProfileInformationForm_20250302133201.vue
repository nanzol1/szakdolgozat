...
const renderImage = (event) => {
    ...
    if(file && file.type.startsWith('image/')){
        ...
        if(user.profile_photo_path){
            imagePreview.value = user.profile_photo_path;
                            ...
                            <v-col cols="12">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        ...
                                        <v-expand-transition>
                                            <div class="bg-gray-200" v-if="imagePreview">
                                                <div class="font-weight-black">Előnézet</div>
                                                <div>
                                                    <div v-if="imagePreview" class="w-[100px] h-[100px]">
                                                        <v-img
                                                          ...
                                                          lazy-src="storage/images/image_nofound.png"
                                                        >
