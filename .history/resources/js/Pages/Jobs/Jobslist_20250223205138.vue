                    ...
                    <div class="w-full xl:w-1/5 mr-5 pr-5">
                        ...
                        <v-expand-transition>
                            <div v-if="isFilterShow">
                                ...
                                <v-btn variant="tonal" @click="handleWorkSchedules" class="mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 mb-5">
                                    Munkarend
                                </v-btn>
                                <transition-group tag="div" name="categories" mode="out-in">
                                ...
                                <v-btn variant="tonal" @click="handleEploymentType" class="mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 mb-5">
                                    Foglalkoztatottság
                                </v-btn>
                                <transition-group tag="div" name="categories" mode="out-in">
