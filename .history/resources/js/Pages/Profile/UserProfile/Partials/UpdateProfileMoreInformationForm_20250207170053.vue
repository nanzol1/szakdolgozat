...
const searchInstitutions = () => {
    if(searchQuery.value.length >=1 ){
        router.get('profile.institutions.search', {
            query: form.institution_name,
        },{
            preserveState: true,
            replace: true,
        });
    ...
    <section class="w-full">
        ...
        >
            ...
            <div>
                ...
                <div v-for="institution in institutions">{{ institution }}</div>
                <div v-if="searchQuery && !institutions.length"></div>
