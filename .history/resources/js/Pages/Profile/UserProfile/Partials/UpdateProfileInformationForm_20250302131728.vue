...
const imagePreview = ref(user.profile_photo_path || null);
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        <div>
                                            ...
                                            :error-messages="form.errors.cv_file" @change="renderImage"></v-file-input>
                                        </div>
                                        <div class="bg-gray-200">
                                            Előnézet
                                            <div>
                                                <div v-if="imagePreview" class="w-[100px] h-[100px]">
                                                    <img :src="imagePreview === user.profile_photo_path ? 'storage/uploads/profile_picture/'+user.id+'/'+imagePreview : imagePreview" alt="Profile picture">
                                                    <v-img
                                                      :width="100"
                                                      :height="100"
                                                      aspect-ratio="16/9"
                                                      cover
                                                      :src="imagePreview === user.profile_photo_path ? 'storage/uploads/profile_picture/'+user.id+'/'+imagePreview : imagePreview"
                                                    ></v-img>
                                                </div>
                                            </div>
                                        </div>
