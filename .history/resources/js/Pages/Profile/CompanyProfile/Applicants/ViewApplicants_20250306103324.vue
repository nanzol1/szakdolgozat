                                ...
                                <v-card class="education-card pa-4 !border-2 !border-solid !border-stone-950 w-[90%] xl:w-[50%] lg:w-[90%] mx-auto">
                                    ...
                                    <div class="flex w-full mt-3 justify-evenly">
                                        <template v-for="(sts, index) in statuses" :key="sts.id">
                                            <div v-if="sts.name !== 'Jelentkezett' && sts.name !== 'Folyamatban'" class="relative flex align-center gap-2 md:gap-2">
                                                <input type="radio" v-model="status" :id="sts.id" :name="sts.name" :value="sts.id" 
                                                class="!border-1 !border-solid !border-black">
                                                <label :for="sts.id" class="w-max">{{ sts.name }}</label>
                                            </div>
                                        </template>
