    ...
    <section class="w-full">
        ...
        >
            <div>
                ...
                <select v-model="form.education_type" name="education_type" id="education_type" class="text-black">
            ...
            <div>
                ...
                <div class="card flex justify-center">
                    <Select v-model="selectedCity" :options="institutions" optionLabel="name" placeholder="Select a City" class="w-full md:w-56" />
                </div>


                <Select v-if="searchQuery.length >= 1 && institutions.length >= 1" v-model="form.institution_name" name="institution_name" id="institution_name">
                    <option value="0">Kérem válasszon a listából!</option>
                    <option v-for="institution in institutions" :key="institution.id" :value="institution.institution_name">
                        {{ institution.institution_name }}
                    </option>
                </Select>
                <div v-if="institutions.length < 1">Nincs találat</div>
            ...
            <div>
                ...
                <DatePicker v-model="form.date_from" view="month" dateFormat="mm/yy" />
            ...
            <div>
                ...
                <DatePicker v-model="form.date_to" view="month" dateFormat="mm/yy" />
