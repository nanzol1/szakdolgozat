                              ...
                              >
                                ...
                                >
                                  ...
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="d-flex flex-col flex-wrap fill-height align-center justify-center overflow-hidden">
                                        <div>{{ featured.companies.company_name }}</div>
                                        <div>{{ featured.name }}</div>
                                        <div>{{ featured.address }}{{ featured.address }}{{ featured.address }}{{ featured.address }}{{ featured.address }}</div>
