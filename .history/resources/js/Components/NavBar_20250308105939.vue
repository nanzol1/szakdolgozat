...
<template>
    ...
    >
        <Disclosure as="nav" :class="['text-gray-950 flex flex-wrap w-full justify-center gap-5 !border-solid !border-b !border-black bg-[#e2ceb1] p-2 xl:text-xl lg:text-md md:text-xs sm:text-sm',{'rounded-xl': isFixed}]" v-slot="{ open }">
