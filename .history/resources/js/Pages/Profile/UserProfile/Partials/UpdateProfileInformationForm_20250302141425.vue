                        ...
                        <v-row>
                            <v-col cols="12">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" lg="6">
                                        <div>
                                            <v-text-field label="Telefonszám" type="text" v-model="form.phone_number" :error="!!errors.form.phone_number" :error-messages="errors.form.phone_number"></v-text-field>
                                        </div>
                                    </v-col>
                                    <v-col cols="12" lg="6">
                                        <div>
