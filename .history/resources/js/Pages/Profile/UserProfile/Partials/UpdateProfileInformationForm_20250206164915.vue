    ...
    <section class="w-full">
        ...
        >
            ...
            <div>
                ...
                <Checkbox v-model:checked="form.driverLicense" id="b"></Checkbox>
                <InputLabel for="c" value="C" />
                <Checkbox v-model:checked="form.driverLicense" id="c"></Checkbox>
                <InputLabel for="d" value="D" />
                <Checkbox v-model:checked="form.driverLicense" id="d"></Checkbox>
                <InputLabel for="be" value="B+E" />
                <Checkbox v-model:checked="form.driverLicense" id="be"></Checkbox>
                <InputLabel for="ce" value="C+E" />
                <Checkbox v-model:checked="form.driverLicense" id="ce"></Checkbox>
                <InputLabel for="de" value="D+E" />
                <Checkbox v-model:checked="form.driverLicense" id="de"></Checkbox>
