...
const generatePDF = async () => {
  ...
  html2canvas(element, {
    ...
    const imgHeight = (canvas.height * imgWidth) / canvas.width; // Képarány fenntartása
    ...
    if (imgHeight > pageHeight) {
      ...
      while (position < imgHeight) {
        pdf.addImage(imgData, "PNG", 0, -position, imgWidth, imgHeight); // A kép megfelelő részének hozzáadása
        position += pageHeight;
