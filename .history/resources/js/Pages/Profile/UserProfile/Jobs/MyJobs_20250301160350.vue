...
const divideAddress = computed(() => {
    if(selectedJob){
        let zip = selectedJob.address.split(',')[0];
        let city = selectedJob.address.split(',')[1];
        let address = selectedJob.address.split(',')[2];
    }
});
</script>
            ...
            <v-row>
                ...
                <v-col cols="6">
                    <v-card v-if="selectedJob">
                        ...
                        <v-card-text>
                            <span class="font-weight-black">{{selectedJob.job_address.split(',')}}</span>
                        </v-card-text>
                    </v-card>
                </v-col>
            </v-row>
