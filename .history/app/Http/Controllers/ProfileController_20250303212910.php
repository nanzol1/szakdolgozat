    ...
    public function updateEducation(Request $request){
        ...
        if($datas){
            $validated = Validator::make($datas, [
                ...
                'education_type.*' => 'Nem lehet üres a mező!',
                'institution_name.*' => 'Nem lehet üres a mező!',
                'education_name.*' => 'Nem lehet üres a mező!',
                'education_level.*' => 'Nem lehet üres a mező!',
                'date_from.*' => 'Nem lehet üres a mező!',
                'date_to.*' => 'Nem lehet üres a mező!',
                'education_place.*' => 'Nem lehet üres a mező!',
            ])->validate();
