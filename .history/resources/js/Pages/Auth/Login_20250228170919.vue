                ...
                <v-row>
                    <v-col cols="12">
                        <div class="w-fit mx-auto">
                            <v-switch :label="computeLabel" prepend-icon="mdi mdi-user" ripple v-model="form.logintype" base-color="#0ea5e9" color="green" false-value="munkavallalo" true-value="munkaltato"></v-switch>
