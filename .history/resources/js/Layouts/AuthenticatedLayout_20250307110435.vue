                            ...
                            <div class="relative ms-3">
                                <v-menu open-on-click>
                                    <template v-slot:activator="{props}">
                                        ...
                                        <v-avatar v-else :image="'/storage/uploads/company_profile/'+$page.props.auth.company !== null ? $page.props.auth.company.id : 0+'/'+$page.props.auth.company !== null ? $page.props.auth.company.profile_pict : 0"></v-avatar>
                                        <v-btn
                                          v-bind="props"
                                          variant="text"
