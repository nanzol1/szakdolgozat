...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        if(!empty($request->driverLicense)){
            ...
            $needChange['driverLicense'] = $cleared;

        }
        dd(count($request->driverLicense));
        Validator::make($needChange,[
        ...
        if($request->user()->update($needChange)){
            if($request->hasFile('cv_file')){
    ...
    public function updateInterests(Request $request){
        ...
        if($interests){
            $request->user()->update(['jobs_interests' => $interests]);
        }
    }
