            ...
            <v-col xl="12" class="break-words">
                <div class="flex xl:flex-row flex-col w-full">
                    <div class="w-full xl:w-1/5 mr-5 pr-5">
                        <v-tooltip text="Szűrők megjelenítése" >
                            <template v-slot:activator="{ props }" :location="start">
                                <v-btn v-bind="props" variant="tonal" :location="start" @click="handleFilterShow" :class="['mr-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105 mb-5',{'!bg-sky-500':isFilterShow}]">
                                    Szűrők
                                </v-btn>
                            </template>
                        </v-tooltip>
