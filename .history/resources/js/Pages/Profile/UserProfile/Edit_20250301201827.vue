...
<template>
    ...
    <Head title="Profile" />
        <template #header>
            ...
            >
                Profilom / Szerkesztés
            </h2>
            <Link :href="route('jobs.show')">Munkák</Link>
            <Link :href="route('profile.myjobs')">Munkáim</Link>
            <Link :href="route('cv.show')">CV Készítő</Link>
        </template>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div class="bg-white p-4 shadow sm:rounded-lg sm:p-8 dark:bg-gray-800  flex flex-row gap-[2em]">

                    <UpdateProfileInterestsForm class="max-w-xl" :category="category" :jobs_interests="jobs_interests"/>
