                ...
                <v-col>
                    <div class="flex">
                        ...
                        <section class="w-1/2" style="box-sizing: border-box;">
                            ...
                            <component ref="cvTemplate" class="flex" :is="tempaltes[0].component" :formData="formData" :isAddition="isAddition" style="width: 100%; height: 100%; min-height: 297mm;"></component>
                        </section>
                    </div>
                </v-col>
            </v-row>
