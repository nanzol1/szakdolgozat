                        ...
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <div v-if="isCompany === 0">
                                    <Link :href="route('dashboard')">
                                        <ApplicationLogo
                                            :class="['block h-9 w-auto fill-current text-stone-950 hover:text-gray-50',{'!text-gray-50':$page.url === '/dashboard'}]"
                                        />
                                    </Link>
                                </div>
                                <div v-else>
                                    <Link :href="route('cdashboard')">
                                        <ApplicationLogo
                                            :class="['block h-9 w-auto fill-current text-stone-950 hover:text-gray-50',{'!text-gray-50':$page.url === '/cdashboard'}]"
                                        />
                                    </Link>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    :class="['text-stone-950 hover:text-gray-50',{'!text-gray-50':$page.url === '/profile'}]"
                                >
                                    Profilom
                                </Link>
                                <Link
