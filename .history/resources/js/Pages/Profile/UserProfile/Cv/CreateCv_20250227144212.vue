                ...
                <v-col>
                    <div class="flex gap-10 h-full">
                        <section class="w-1/2">
                            ...
                            :css="false"
                            >
                            <v-form v-model="valid" @submit.prevent="handleMainFormSubmit" enctype="multipart/form-data">
                              <v-container>
                                <v-row>
                                  <v-col
                                    cols="12"
                            ...
                            <div v-if="currentStepIndex === -1" key="initial">
                                <form >
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="firstname" type="text" v-model="formData.firstname" autocomplete="firstname" required></TextInput>
