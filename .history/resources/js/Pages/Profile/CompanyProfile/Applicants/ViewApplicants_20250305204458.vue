                            ...
                            {{ apps }}
                                ...
                                <v-card class="mb-3 pa-3">
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn @click="router.visit('storage/uploads/cv/'+apps.user.cv_file)" :download="apps.user.name+'.pdf'" class="hover:bg-sky-500 hover:text-gray-50" v-if="apps.user.cv_file">Önéletrajz</v-btn>
                                    </v-card-actions>
                                </v-card>
                            </div>
