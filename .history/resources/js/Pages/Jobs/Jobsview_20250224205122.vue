                                ...
                                <div class="flex sm:gap-10">
                                    ...
                                    <div class="flex flex-col flex-1 gap-3">
                                        ...
                                        <div :class="['flex flex-row w-full sm:w-fit',{'h-full align-center':!user}]">
                                            <v-btn variant="tonal" @click="sendApplication" :disabled="isApplied" v-if="isJobActive" :class="['mr-3 max-sm:!h-full max-sm:!pa-3 !text-stone-50 !bg-gray-500 hover:!bg-sky-500 hover:scale-105']">
                                                {{ computeApplied }}
                                            </v-btn>
