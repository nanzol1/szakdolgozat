                ...
                <v-row>
                    <v-col cols="12">
                        <div class="w-fit mx-auto">
                            <v-switch center-affix="center" :label="computeLabel" v-model="form.logintype" base-color="#0ea5e9" color="green" false-value="munkavallalo" true-value="munkaltato"></v-switch>
