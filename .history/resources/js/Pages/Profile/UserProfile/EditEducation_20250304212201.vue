        ...
        <v-container>
            <v-row>
                ...
                <v-overlay v-model="overlay" width="50%" scroll-strategy="reposition" class="align-center justify-center">
                    <v-card class="education-card !border-2 !border-solid !border-stone-950 " elevation="20">
...
<style>
    ...
    .education-card{
        background-image: linear-gradient(to left top, #000000, #1e1e1e, #353535, #4e4e4e, #696969, #7e7e7e, #939393, #a9a9a9, #bebebe, #d3d3d3, #e9e9e9, #ffffff);
    }
</style>
