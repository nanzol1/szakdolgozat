                            ...
                            <div v-for="job in jobs" :key="job.id">
                                <Link :href="route('jobs.view',{id:job.id})">
                                    <v-card
                                      ...
                                      elevation="2"
                                      :prepend-avatar="'storage/uploads/company_profile/'+job.company_id+'/'+job.company_avatar"
                                      prepend-icon="1212"
                                    >
                                        <template v-if="!job.company_avatar">
                                            <v-icon notranslate v-theme--light v-icon--size-default>mdi-account</v-icon>
                                        </template>
