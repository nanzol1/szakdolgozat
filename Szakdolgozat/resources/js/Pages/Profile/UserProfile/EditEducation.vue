...
const deleteEducation = () => {
    router.post(route('profile.update.education.delete'),{id:selectedEducation.value.id},{onSuccess: () => {
...
<template>
            ...
            <v-row>
                <v-col>
                    ...
                    <div class="flex gap-3 md:gap-5 text-md mt-3">
                        ...
                        <Link :href="route('profile.edit.educations')" :class="['hover:text-[#fff] transition',{'text-gray-50':$page.url.includes('kepzettsegek')}]">Képzettségek</Link>
                        <Link :href="route('profile.edit.cv')" :class="['hover:text-[#fff] transition']">Önéletrajz</Link>
                    </div>
                </v-col>
            </v-row>
        </v-container>
    ...
    <div class="max-w-7xl mx-auto">
        <v-container>
            <v-row>
                <v-col cols="12">
                    <v-btn @click="newEducation = !newEducation" class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50 mb-3" append-icon="mdi mdi-plus-circle-outline">Új végzettség felvétele</v-btn>
                    <v-expand-transition>
                        <div
                    ...
                    <v-card class="education-card !border-2 !border-solid !border-stone-950 w-[90%] xl:w-[40%] lg:w-[90%] mx-auto" elevation="20">
                        ...
                        <div class="flex flex-col pa-5">
                            ...
                            <div class="flex justify-between flex-wrap mt-2">
                                <div>
                                    <v-btn class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50" @click="deleteOverlay = true">Törlés</v-btn>
                                </div>
                                <div class="flex gap-2 md:gap-4 flex-wrap">
                                    <v-btn v-if="isEditing" type="submit" @click="submit" class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50">Mentés</v-btn>
                                    <v-btn @click="isEditing = !isEditing" v-else class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50">Szerkeszt</v-btn>
                                    <v-btn class="!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50" @click="overlay = false; isEditing = false">Mégsem</v-btn>
                                </div>
                            </div>
                        </div>
                    </v-card>
