...
class DashboardController extends Controller{
    ...
    public function getAppliedJobsTable(Request $request)
    {
        ...
        $applications->join('job_vacancies', 'job_vacancies.id', '=', 'applications.job_id')
             ->join('jobs_subcategories', 'jobs_subcategories.id', '=', 'job_vacancies.subcateg_id')
             ->join('jobs_statuses','jobs_statuses.id','=','applications.status');
        if ($request->has('sortBy')) {
            ...
            switch ($request->sortBy) {
                ...
                case 'status':
                    $applications->orderBy('job_status.name', $sortDirection);
                    break;
