                              ...
                              >
                                ...
                                >
                                  ...
                                  <Link :href="route('jobs.view',{id:featured.id})">
                                    <div class="grid grid-rows-4  divide-dashed h-full gap-4 align-center justify-center overflow-hidden">
                                        <div class="align-start">{{ featured.name }}</div>
                                        <div>{{ featured.jobs_subcategory.name }}</div>
                                        <div>{{ featured.description }}</div>
                                        <div class="">{{ featured.companies.company_name }}</div>
