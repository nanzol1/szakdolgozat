    ...
    public function updateEducation(Request $request){
        ...
        if($datas){
            ...
            $validated = Validator::make($datas, [
                ...
                'education_type.required' => 'required|string',
                'institution_name.required' => 'required|string|min:3|max:255',
                'education_name.required' => 'required|string|min:3|max:255',
                'date_from.required' => 'required|date',
                'date_to.required' => 'required|date',
                'education_place.required' => 'required|string',
            ])->validate();
