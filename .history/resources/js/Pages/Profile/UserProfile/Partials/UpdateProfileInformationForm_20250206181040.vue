...
onMounted(() => {
    form.driverLicense = user.driverLicense;
    displayCV();
    console.log(form.driverLicense);
});
watch(form.driverLicense,(newValue) => {
        driverLicenses.value = newValue;
    },{deep:true});
    ...
    <section class="w-full">
        ...
        >
            ...
            <div>
                ...
                <Checkbox v-model:checked="form.driverLicense" id="a" value="a">asd</Checkbox>
