...
<template>
    ...
    <div class="bg-gray-50 text-black/100 dark:bg-black dark:text-white/50 pb-10">
        ...
        >
            <v-container fluid class="pa-0  shadow-md relative">
                <v-img src='storage/images/home_bg.jpg' class="!z-10" aspect-ratio="16/9" absolute cover width="100%" height="100%"></v-img>
                <v-container class="relative !z-11">
                    <v-row>
                        <v-col>
