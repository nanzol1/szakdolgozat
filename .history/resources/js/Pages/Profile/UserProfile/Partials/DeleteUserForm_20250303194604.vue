    ...
    <section class="space-y-6">
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <div class="mt-6">
                    <v-text-field label="Jelszó" v-model="form.errors.password" :error="!!form.errors.password"
                    :error-messages="form.errors.current_password" ref="passwordInput" id="password" type="password" @keyup.enter="deleteUser"></v-text-field>
                    <TextInput
                        id="password"
                        ref="passwordInput"
