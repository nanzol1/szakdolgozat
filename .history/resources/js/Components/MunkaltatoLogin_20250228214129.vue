    ...
    <div>
        ...
        <v-form @submit.prevent="validate" ref="formValidator">    
            ...
            <div class="mt-3 flex align-center">
                <span>Elfelejtettem a jelszavam!</span> <v-btn class="hover:bg-sky-500 hover:text-gray-50" @click="router.visit(route('password.request'))">Elfelejtett jelszó</v-btn>
            </div>
        </v-form>
    </div>
</template>