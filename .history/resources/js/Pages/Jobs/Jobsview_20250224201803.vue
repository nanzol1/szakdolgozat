        ...
        <v-container class="flex-col pa-0" fluid>
                            ...
                            <v-col>
                                ...
                                <div class="flex sm:gap-10">
                                    ...
                                    <div class="flex flex-col flex-1 justify-between">
                                        ...
                                        <div :class="['flex flex-col p-3 md:p-3 bg-gray-400 w-full md:w-1/4 text-center',{'md:w-1/4':job.payment}]">
                                            <div class="block">Havi bérezés</div>
                                            <div class="text-xl font-weight-black flex gap-2 align-center justify-center">
            ...
            <v-container>
                <div class="w-full md:max-w-7xl mx-auto">
                    <v-row>
                        <v-col sm="12">
                            <div class="text-lg font-weight-black mb-3" v-if="job.description">
                                Munka leírása:
                            </div>
                            <div>
                                {{ job.description }}
                        ...
                        <v-col sm="12">
                            <div class="text-lg font-weight-black mb-3" v-if="job.requirements">
                                Elvárások:
                            </div>
                            <div>
                                {{ job.requirements }}
