    ...
    <AuthenticatedLayout>
        <div class="flex max-w-7xl mx-auto">
            <v-container>
                <v-row>
                    <v-col cols="12" lg="6">
                        <section class="bg-white p-4 shadow sm:rounded-lg sm:p-8 sm:py-3 dark:bg-gray-800 flex justify-between">
                            <v-form
                                ...
                                <v-col cols="12">
                                    ...
                                    <template v-for="schedules in computeSchedules" :key="schedules.id">
                                        <div class="flex align-center gap-2 mb-2">
                                            ...
                                            <Checkbox class="!border-1 !border-solid !border-stone-950" v-model:checked="form.work_schedules" :value="schedules.id" :id="schedules.name"></Checkbox>
                                        </div>
                                    </template>
                                </v-col>
                                <v-col cols="12">
