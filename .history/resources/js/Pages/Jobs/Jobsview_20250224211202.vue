                        ...
                        <v-row>
                            <v-col cols="12">
                                <div class="text-lg font-weight-black mb-2">
                                    <Link class="hover:text-sky-500 transition" :href="'/munkak?category[0]='+job.maincateg_id">{{ job.categories.maincateg_name }}</Link> / <Link class="hover:text-sky-500 transition" :href="'/munkak?subcategory[0]='+job.subcateg_id">{{ job.subcateg_name }}</Link>
                                </div>
