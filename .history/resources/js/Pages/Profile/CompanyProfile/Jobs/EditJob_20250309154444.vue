                ...
                <v-row>
                    <v-col>
                        ...
                        <div class="flex gap-3 md:gap-5 text-md mt-3 flex-col md:flex-row">
                            ...
                            <Link :href="route('cprofile.myjobs')" :class="['hover:text-[#fff] transition',{'text-gray-50':$page.url.includes('cmunkaim')}]">Munkáim / Szerkesztés</Link>
                        </div>
                    </v-col>
                </v-row>
            </v-container>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        <div v-for="(cats, catKey) in props.categories" :key="catKey">
                                            ...
                                            @click="isCatShown = cats.id" :class="['!bg-[#A67C52] hover:!bg-[#3A2618] !text-gray-50 hover:text-gray-50 mb-2',{'!bg-[#422f21] !text-gray-50':isCatShown == cats.id}]">{{ cats.name }}</v-btn>
