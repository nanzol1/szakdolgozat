    ...
    <section class="w-full">
        ...
        >
            ...
            <div>
                ...
                <Checkbox v-model:checked="form.driverLicenses" id="none" value="none"></Checkbox>
                <InputLabel for="a" value="A" />
                <Checkbox v-model:checked="form.driverLicenses" id="a" value="a"></Checkbox>
                <InputLabel for="b" value="B" />
                <Checkbox v-model:checked="form.driverLicenses" id="b" value="b"></Checkbox>
                <InputLabel for="c" value="C" />
                <Checkbox v-model:checked="form.driverLicenses" id="c" value="c"></Checkbox>
                <InputLabel for="d" value="D" />
                <Checkbox v-model:checked="form.driverLicenses" id="d" value="d"></Checkbox>
                <InputLabel for="be" value="B+E" />
                <Checkbox v-model:checked="form.driverLicenses" id="be" value="be"></Checkbox>
                <InputLabel for="ce" value="C+E" />
                <Checkbox v-model:checked="form.driverLicenses" id="ce" value="ce"></Checkbox>
                <InputLabel for="de" value="D+E" />
                <Checkbox v-model:checked="form.driverLicenses" id="de" value="de"></Checkbox>
