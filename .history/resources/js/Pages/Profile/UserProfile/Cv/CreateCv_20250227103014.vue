            ...
            <v-row>
                <v-col>
                    <div class="flex">
                        ...
                        <section class="w-1/2 h-screen" style="left: 0; top: 0;">
                            <!--<div v-html="templateContent"></div>-->
                            <component ref="cvTemplate" :is="tempaltes[0].component" :formData="formData" :isAddition="isAddition" style="left: 0; top: 0;"></component>
                        </section>
                    </div>
                </v-col>
            </v-row>
