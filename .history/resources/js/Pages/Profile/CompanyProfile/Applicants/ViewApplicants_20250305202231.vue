                ...
                <v-row>
                    <v-col>
                        ...
                        <div class="flex gap-3 md:gap-5 text-md mt-3">
                            <Link :href="route('cprofile.edit')" :class="['hover:text-sky-500 transition',{'text-sky-500':$page.url === '/cprofile'}]">Alap adataim</Link>
                            <Link href="" class="hover:text-sky-500 transition">Érdekeltségeim</Link>
                            <Link href="" class="hover:text-sky-500 transition">Képzettségek</Link>
                            <Link href="" :class="['hover:text-sky-500 transition',{'text-sky-500':$page.url.includes('/cv')}]">Önéletrajz</Link>
                        </div>
                        <v-divider></v-divider>
                    </v-col>
                </v-row>
