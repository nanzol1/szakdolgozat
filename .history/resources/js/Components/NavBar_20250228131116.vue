...
const navigation = [
  ...
  { name: 'Bejelentkezés', href: isLoggedIn ?? route('login'), current: page.url === '/login' ? true : false },
  { name: 'Regisztráció', href: isLoggedIn ?? route('register',{type:''}), current: page.url === '/register' ? true : false },
  { name: 'Profilom', href: is_company === 1 && isLoggedIn ? route('cprofile.edit') : route('profile.edit'), current: page.url === '/profile' ? true : false },
]
