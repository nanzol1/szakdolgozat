...
const computeStatuses = computed(() => {
    props.statuses.forEach(element => {
        return element !== 'Jelentkezett';
    });
});
console.log(computeStatuses);
</script>
                    ...
                    <v-col cols="12">
                        <section>
                            ...
                            <v-overlay v-model="isPopup" class="align-center justify-center" width="100%">
                                <v-card class="education-card pa-4 !border-2 !border-solid !border-stone-950 w-[90%] xl:w-[40%] lg:w-[90%] mx-auto">
                                    ...
                                    <template v-for="(sts, index) in computeStatuses" :key="sts.id">
                                        <div>
