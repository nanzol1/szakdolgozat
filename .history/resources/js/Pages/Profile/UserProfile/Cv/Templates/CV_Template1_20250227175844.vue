...
<template>
    <div class="elevation-4" style="width: 100%; height: 100%; background-color: #fff;">
        <div class="w-full" style="word-wrap: break-word;  max-width: 800px; width: 100%; padding: 20px; background-color: #fff;">
            ...
            {{ formData.educations[0]?.title !== '' }}
            <div style="margin-bottom: 15px;" v-if="formData.educations.length > 0 && formData.educations[0]?.title !== ''">
            ...
            <div style="margin-bottom: 15px;" v-if="formData.skills.length > 0 && formData.skills[0]?.title !== ''">
