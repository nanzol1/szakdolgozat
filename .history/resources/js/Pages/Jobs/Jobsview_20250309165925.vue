                                ...
                                <v-col cols="12">
                                    ...
                                    <div class="flex sm:gap-10">
                                        ...
                                        <v-sheet :elevation="5" :height="200" :width="200" class="!hidden sm:!block" v-else>
                                            <v-img :lazy-src="'/storage/images/image_nofound.png'" :src="'/storage/images/image_nofound.png'" width="100%" height="100%" cover>
                                                <template v-slot:placeholder>
                                                  <div class="d-flex align-center justify-center fill-height">
                                                    <v-progress-circular
                                                      color="grey-lighten-4"
                    ...
                    <div class="w-full md:max-w-7xl mx-auto">
                        ...
                        <v-row class="sm:!mt-10">
                            <v-col>
                                ...
                                >
                                    <Link v-for="(job, index) in jobs" :key="job.id" :href="route('jobs.view',{id:job.id})" class="ncard">
                                        <n-card
                                          :segmented="{
                                            content: true,
                                            footer: 'soft',
                                    ...
                                    <template #arrow="{ prev, next }">
                                      <div class="custom-arrow">
                                        <button type="button" class="custom-arrow--left  hover:!bg-[#c7a07a]" @click="prev">
                                          <v-icon icon="mdi mdi-chevron-left" size="30px"></v-icon>
                                        </button>
                                        <button type="button" class="custom-arrow--right hover:!bg-[#c7a07a]" @click="next">
