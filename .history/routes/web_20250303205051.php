...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profil/erdekeltsegeim', [ProfileController::class, 'editInterests'])->name('profile.edit.interests');
    Route::get('/profil/kepzettsegek', [ProfileController::class, 'editEducations'])->name('profile.edit.educations');
    Route::post('/profil', [ProfileController::class, 'update'])->name('profile.update');
    Route::post('/profil', [ProfileController::class, 'destroy'])->name('profile.destroy');
    Route::get('munkaim',[JobsController::class,'getMyJobs'])->name('profile.myjobs');
    Route::post('profil/uploadPhoto',[ProfileController::class,'uploadProfilePicture'])->name('profile.save.photo');
