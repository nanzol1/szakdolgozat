...
const generatePDF = () => {
    ...
    cvTemplate.value.generatePdf();
  if (cvTemplate.value?.$el) {
    html2pdf()
      .from(cvTemplate.value?.$el)
      .save("document.pdf");
  }
};
                            ...
                            :show-layout="false"
                                ...
                                <template #pdf-content>
                                    <div class="w-full h-screen">
                                        <component v-if="tempaltes[0]" :is="tempaltes[0].component" :formData="formData" :isAddition="isAddition" style="width: 100%; height: 100%;"></component>
                                    </div>
                                </template>
                            </vue3-html2pdf>
