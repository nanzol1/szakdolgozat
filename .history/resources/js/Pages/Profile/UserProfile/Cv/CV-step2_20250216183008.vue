  ...
  <div>
    <form @submit.prevent="handleSubmit">
      <template v-for="(educ, index) in educations" :key="index">
        <div>
          <InputLabel for="school_name" value="Munka megnevezése"></InputLabel>
          <TextInput id="school_name" type="text" v-model="educ.title" autocomplete="title"></TextInput>

          <InputLabel for="employer" value="Munkáltató"></InputLabel>
          <TextInput id="employer" type="text" v-model="educ.employer" autocomplete="employer"></TextInput>
