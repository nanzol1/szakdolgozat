            ...
            <div class="relative flex flex-col items-center py-8 h-auto bg-gray-100 dark:bg-gray-600 dark:text-gray-50 text-stone-950 w-full">
                <div class="flex flex-col max-w-7xl items-center">
                    ...
                    <div class="lg:mt-5">
                        ...
                        <v-btn variant="elevated" @click="router.visit(route('jobs.list'))" class="!text-stone-50 !bg-gray-500">
                            Munkák böngészése
                        </v-btn>
                    </div>
                </div>
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-6">
                    ...
                    <div class="grid gap-6 lg:gap-2">
                        ...
                        <v-pagination v-model="currentPage" :length="totalPages" @update:model-value="fetchJobs"></v-pagination>
                    </div>
                </main>
            </div>
        </div>
