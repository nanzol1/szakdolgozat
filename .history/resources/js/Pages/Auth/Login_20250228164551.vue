                ...
                <v-row>
                    <v-col cols="12">
                        <div class="w-fit mx-auto">
                            <div>
                            <v-field-label v-slot:label title="asd"></v-field-label>
                            <v-switch  v-model="form.logintype" base-color="black" false-value="munkavallalo" true-value="munkaltato"></v-switch>
