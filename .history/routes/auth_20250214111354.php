...
Route::middleware('auth:company')->group(function () {
    ...
    Route::get('munkaim/edit/{id}/employment',[CompanyProfileController::class,'getEmploymentsType'])->name('profile.employment.search'); 
    Route::get('munkaim/edit/{id}/profile/schedules',[CompanyProfileController::class,'getWorkSchedules'])->name('profile.schedules.search'); 
