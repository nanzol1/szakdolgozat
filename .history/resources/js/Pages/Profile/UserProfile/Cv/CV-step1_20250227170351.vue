      ...
      <template v-for="(exp, index) in exps" :key="index">
        <v-container>
          <v-row>
            ...
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="exp.startdate" type="month" clearable size="large" placeholder="Kezdés ideje"/>
            </v-col>
            <v-col cols="12" md="6">
              <n-date-picker v-model:value="exp.enddate" type="month" clearable size="large" placeholder="Végzés ideje"/>
            </v-col>
