...
const steps = [
    {component: CV_step1, key: 'step1',name:'Egy'},
    {component: CV_step2, key: 'step2',name:'Ketto'},
    {component: CV_step3, key: 'step3',name:'Egy'},
    {component: CV_step4, key: 'step4',name:'Egy'},
];
    ...
    <GuestPageLayout :canLogin="canLogin" :canRegister="canRegister">
        <div class="flex align-center">
            <section class="w-full">
                {{ Object.values(steps.name) }}
                <v-stepper :items="['s','s']" ref="stepper">
