...
// Magyar hónapok és napok listája
const months = ['Jan.', 'Febr.', 'Márc.', 'Ápr.', 'Máj.', 'Jún.', 'Júl.', 'Aug.', 'Szept.', 'Okt.', 'Nov.', 'Dec.'];
const days = ['V', 'H', 'K', 'Sze', 'Cs', 'P', 'Szo']; // Vasárnaptól kezdődően

// Egyedi label-rendering függvény
const renderLabel = (type, value) => {
  if (type === 'month') return months[value];
  if (type === 'day') return days[value];
  return value;
};
  const removeCV = () => {
    if(pdfViewer.value){
