...
// Magyar rövid napok
const shortWeekdays = ['Hé', 'Ke', 'Sze', 'Cs', 'Pé', 'Szo', 'Vas'];

// `render-label` módosítása
const renderLabel = (type, value) => {
  if (type === 'month') return customLocale.DatePicker.shortMonths[value];
  if (type === 'day') return shortWeekdays[value];
  return value;
};
                                    ...
                                    <v-col cols="12" lg="6">
                                        <div class="h-[56px] flex align-center">
                                            <n-config-provider :locale="customLocale">
                                                ...
                                                :update-value-on-close="true" :render-label="renderLabel" placeholder="Születési dátum" size="large"/>
                                            </n-config-provider>
