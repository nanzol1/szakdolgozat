    ...
    <section class="w-full">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div v-for="categories in category" :key="category.id">
                ...
                <Checkbox :value="categories.name,categories.id" v-model:checked="checkboxes" :id="categories.name" @change="toggleSubcategories(categories)">{{ categories.name }}</Checkbox>
